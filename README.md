...
| cabalVersion                    | Set the cabal version number, consisting of a sequence of one or more integers separated by dots                              | 0.1.0.0  | 0.1.2.0                    |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| SendinBlue.Client    | use the "dispatch" functions to send requests       |
| SendinBlue.Core      | core functions, config and request types            |
| SendinBlue.API       | construct api requests                              |
| SendinBlue.Model     | describes api models                                |
| SendinBlue.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| SendinBlue.ModelLens | lenses for model fields                             |
| SendinBlue.Logging   | logging functions and utils                         |
