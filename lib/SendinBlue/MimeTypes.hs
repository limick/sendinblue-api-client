...
module SendinBlue.MimeTypes where
...
-- ** MimeApplicationsJson

data MimeApplicationsJson = MimeApplicationsJson deriving (P.Typeable)

-- | @applications/json@
instance MimeType MimeApplicationsJson where
  mimeType _ = Just $ P.fromString "applications/json"
-- instance MimeRender MimeApplicationsJson T.Text where mimeRender _ = undefined
-- instance MimeUnrender MimeApplicationsJson T.Text where mimeUnrender _ = undefined
