...
instance HasOptionalParam GetSmsEvents PhoneNumber where
  applyOptionalParam req (PhoneNumber xs) =
    req `setQuery` toQuery ("phoneNumber", Just xs)
...
-- | @application/json@
instance Consumes GetSmsEvents MimeJSON
...
-- | @application/json@
instance Consumes GetTransacAggregatedSmsReport0 MimeJSON
...
-- | @application/json@
instance Consumes GetTransacSmsReport0 MimeJSON
