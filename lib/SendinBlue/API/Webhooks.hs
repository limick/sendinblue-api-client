...
-- | @application/json@
instance Consumes DeleteWebhook MimeJSON
...
-- | @application/json@
instance Consumes GetWebhook0 MimeJSON
...
-- | @application/json@
instance Consumes GetWebhooks0 MimeJSON
...
updateWebhook0 (WebhookId webhookId) updateWebhook =
