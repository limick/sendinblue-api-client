...
addContactToList0 (ListId listId) contactEmails =
...
createAttribute0 
  ...
  -> SendinBlueRequest CreateAttribute0 MimeJSON res MimeJSON
createAttribute0 (AttributeCategory2 attributeCategory) (AttributeName attributeName) createAttribute =
...
-- | @application/json@
instance Produces CreateAttribute0 MimeJSON
...
deleteAttribute 
  ...
  -> SendinBlueRequest DeleteAttribute MimeNoContent res MimeJSON
...
-- | @application/json@
instance Consumes DeleteAttribute MimeJSON

-- | @application/json@
instance Produces DeleteAttribute MimeJSON
...
deleteContact 
  ...
  -> SendinBlueRequest DeleteContact MimeNoContent res MimeJSON
...
-- | @application/json@
instance Consumes DeleteContact MimeJSON

-- | @application/json@
instance Produces DeleteContact MimeJSON
...
deleteFolder 
  ...
  -> SendinBlueRequest DeleteFolder MimeNoContent res MimeJSON
...
-- | @application/json@
instance Consumes DeleteFolder MimeJSON

-- | @application/json@
instance Produces DeleteFolder MimeJSON
...
deleteList 
  :: ListId -- ^ "listId" -  Id of the list
  -> SendinBlueRequest DeleteList MimeNoContent res MimeJSON
...
-- | @application/json@
instance Consumes DeleteList MimeJSON

-- | @application/json@
instance Produces DeleteList MimeJSON
...
-- | @application/json@
instance Consumes GetAttributes0 MimeJSON
...
-- | @application/json@
instance Consumes GetContactInfo MimeJSON
...
-- | @application/json@
instance Consumes GetContactStats MimeJSON
...
instance HasOptionalParam GetContacts0 ModifiedSince where
  applyOptionalParam req (ModifiedSince xs) =
    req `setQuery` toQuery ("modifiedSince", Just xs)

-- | @application/json@
instance Consumes GetContacts0 MimeJSON
...
-- | @application/json@
instance Consumes GetContactsFromList MimeJSON
...
-- | @application/json@
instance Consumes GetFolder0 MimeJSON
...
-- | @application/json@
instance Consumes GetFolderLists0 MimeJSON
...
-- | @application/json@
instance Consumes GetFolders0 MimeJSON
...
-- | @application/json@
instance Consumes GetList0 MimeJSON
...
-- | @application/json@
instance Consumes GetLists0 MimeJSON
...
removeContactFromList0 (ListId listId) contactEmails =
...
updateAttribute0 
  ...
  -> SendinBlueRequest UpdateAttribute0 MimeJSON res MimeJSON
updateAttribute0 (AttributeCategory attributeCategory) (AttributeName attributeName) updateAttribute =
...
-- | @application/json@
instance Produces UpdateAttribute0 MimeJSON
...
updateContact0 
  ...
  -> SendinBlueRequest UpdateContact0 MimeJSON res MimeJSON
updateContact0 (Email email) updateContact =
...
-- | @application/json@
instance Produces UpdateContact0 MimeJSON
...
updateFolder 
  ...
  -> SendinBlueRequest UpdateFolder MimeJSON res MimeJSON
updateFolder (FolderId folderId) updateFolder =
...
-- | @application/json@
instance Produces UpdateFolder MimeJSON
...
updateList0 
  ...
  -> SendinBlueRequest UpdateList0 MimeJSON res MimeJSON
updateList0 (ListId listId) updateList =
...
-- | @application/json@
instance Produces UpdateList0 MimeJSON
