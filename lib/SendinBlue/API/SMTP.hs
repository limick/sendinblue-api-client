...
-- | @application/json@
instance Consumes DeleteSmtpTemplate MimeJSON
...
instance HasOptionalParam GetAggregatedSmtpReport Days where
  applyOptionalParam req (Days xs) =
    req `setQuery` toQuery ("days", Just xs)
...
-- | @application/json@
instance Consumes GetAggregatedSmtpReport MimeJSON
...
instance HasOptionalParam GetEmailEventReport0 Email where
  applyOptionalParam req (Email xs) =
    req `setQuery` toQuery ("email", Just xs)
...
instance HasOptionalParam GetEmailEventReport0 Event where
  applyOptionalParam req (Event xs) =
    req `setQuery` toQuery ("event", Just xs)
...
instance HasOptionalParam GetEmailEventReport0 MessageId where
  applyOptionalParam req (MessageId xs) =
    req `setQuery` toQuery ("messageId", Just xs)
...
-- | @application/json@
instance Consumes GetEmailEventReport0 MimeJSON
...
-- | @application/json@
instance Consumes GetSmtpReport MimeJSON
...
-- | @application/json@
instance Consumes GetSmtpTemplate MimeJSON
...
instance HasOptionalParam GetSmtpTemplates0 TemplateStatus where
  applyOptionalParam req (TemplateStatus xs) =
    req `setQuery` toQuery ("templateStatus", Just xs)
...
-- | @application/json@
instance Consumes GetSmtpTemplates0 MimeJSON
...
instance HasOptionalParam GetTransacBlockedContacts0 Senders where
  applyOptionalParam req (Senders xs) =
    req `setQuery` toQueryColl CommaSeparated ("senders", Just xs)

-- | @application/json@
instance Consumes GetTransacBlockedContacts0 MimeJSON
...
-- | @application/json@
instance Consumes GetTransacEmailContent0 MimeJSON
...
instance HasOptionalParam GetTransacEmailsList0 StartDateText where
  applyOptionalParam req (StartDateText xs) =
    req `setQuery` toQuery ("startDate", Just xs)
...
-- | @application/json@
instance Consumes GetTransacEmailsList0 MimeJSON
...
sendTemplate (TemplateId templateId) sendEmail =
...
sendTestTemplate (TemplateId templateId) sendTestEmail =
...
-- | @application/json@
instance Consumes SmtpBlockedContactsEmailDelete MimeJSON
...
updateSmtpTemplate0 (TemplateId templateId) smtpTemplate =
