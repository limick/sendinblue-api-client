...
addContactToList1 (ListId listId) contactEmails =
...
-- | @application/json@
instance Consumes DeleteList0 MimeJSON
...
-- | @application/json@
instance Consumes GetContactsFromList0 MimeJSON
...
-- | @application/json@
instance Consumes GetFolderLists2 MimeJSON
...
-- | @application/json@
instance Consumes GetList1 MimeJSON
...
-- | @application/json@
instance Consumes GetLists1 MimeJSON
...
removeContactFromList1 (ListId listId) contactEmails =
...
updateList1 (ListId listId) updateList =
