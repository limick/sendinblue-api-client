...
-- ** ChildIdentifier
newtype ChildIdentifier = ChildIdentifier { unChildIdentifier :: Text } deriving (P.Eq, P.Show)
...
-- ** StartDateDate
newtype StartDateDate = StartDateDate { unStartDateDate :: Date } deriving (P.Eq, P.Show)
...
-- | AbTestCampaignResult
data AbTestCampaignResult = AbTestCampaignResult
  { abTestCampaignResultWinningVersion :: !(Maybe E'WinningVersion) -- ^ "winningVersion" - Winning Campaign Info. pending &#x3D; Campaign has been picked for sending and winning version is yet to be decided, tie &#x3D; A tie happened between both the versions, notAvailable &#x3D; Campaign has not yet been picked for sending.
  , abTestCampaignResultWinningCriteria :: !(Maybe E'WinningCriteria) -- ^ "winningCriteria" - Criteria choosen for winning version (Open/Click)
  , abTestCampaignResultWinningSubjectLine :: !(Maybe Text) -- ^ "winningSubjectLine" - Subject Line of current winning version
  , abTestCampaignResultOpenRate :: !(Maybe Text) -- ^ "openRate" - Open rate for current winning version
  , abTestCampaignResultClickRate :: !(Maybe Text) -- ^ "clickRate" - Click rate for current winning version
  , abTestCampaignResultWinningVersionRate :: !(Maybe Text) -- ^ "winningVersionRate" - Open/Click rate for the winner version
  , abTestCampaignResultStatistics :: !(Maybe AbTestCampaignResultStatistics) -- ^ "statistics"
  , abTestCampaignResultClickedLinks :: !(Maybe AbTestCampaignResultClickedLinks) -- ^ "clickedLinks"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON AbTestCampaignResult
instance A.FromJSON AbTestCampaignResult where
  parseJSON = A.withObject "AbTestCampaignResult" $ \o ->
    AbTestCampaignResult
      <$> (o .:? "winningVersion")
      <*> (o .:? "winningCriteria")
      <*> (o .:? "winningSubjectLine")
      <*> (o .:? "openRate")
      <*> (o .:? "clickRate")
      <*> (o .:? "winningVersionRate")
      <*> (o .:? "statistics")
      <*> (o .:? "clickedLinks")

-- | ToJSON AbTestCampaignResult
instance A.ToJSON AbTestCampaignResult where
  toJSON AbTestCampaignResult {..} =
   _omitNulls
      [ "winningVersion" .= abTestCampaignResultWinningVersion
      , "winningCriteria" .= abTestCampaignResultWinningCriteria
      , "winningSubjectLine" .= abTestCampaignResultWinningSubjectLine
      , "openRate" .= abTestCampaignResultOpenRate
      , "clickRate" .= abTestCampaignResultClickRate
      , "winningVersionRate" .= abTestCampaignResultWinningVersionRate
      , "statistics" .= abTestCampaignResultStatistics
      , "clickedLinks" .= abTestCampaignResultClickedLinks
      ]


-- | Construct a value of type 'AbTestCampaignResult' (by applying it's required fields, if any)
mkAbTestCampaignResult
  :: AbTestCampaignResult
mkAbTestCampaignResult =
  AbTestCampaignResult
  { abTestCampaignResultWinningVersion = Nothing
  , abTestCampaignResultWinningCriteria = Nothing
  , abTestCampaignResultWinningSubjectLine = Nothing
  , abTestCampaignResultOpenRate = Nothing
  , abTestCampaignResultClickRate = Nothing
  , abTestCampaignResultWinningVersionRate = Nothing
  , abTestCampaignResultStatistics = Nothing
  , abTestCampaignResultClickedLinks = Nothing
  }

-- ** AbTestCampaignResultClickedLinks
-- | AbTestCampaignResultClickedLinks
data AbTestCampaignResultClickedLinks = AbTestCampaignResultClickedLinks
  { abTestCampaignResultClickedLinksVersionA :: !([A.Value]) -- ^ /Required/ "Version A" - Information on clicked links for a particular version
  , abTestCampaignResultClickedLinksVersionB :: !([A.Value]) -- ^ /Required/ "Version B" - Information on clicked links for a particular version
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON AbTestCampaignResultClickedLinks
instance A.FromJSON AbTestCampaignResultClickedLinks where
  parseJSON = A.withObject "AbTestCampaignResultClickedLinks" $ \o ->
    AbTestCampaignResultClickedLinks
      <$> (o .:  "Version A")
      <*> (o .:  "Version B")

-- | ToJSON AbTestCampaignResultClickedLinks
instance A.ToJSON AbTestCampaignResultClickedLinks where
  toJSON AbTestCampaignResultClickedLinks {..} =
   _omitNulls
      [ "Version A" .= abTestCampaignResultClickedLinksVersionA
      , "Version B" .= abTestCampaignResultClickedLinksVersionB
      ]


-- | Construct a value of type 'AbTestCampaignResultClickedLinks' (by applying it's required fields, if any)
mkAbTestCampaignResultClickedLinks
  :: [A.Value] -- ^ 'abTestCampaignResultClickedLinksVersionA': Information on clicked links for a particular version
  -> [A.Value] -- ^ 'abTestCampaignResultClickedLinksVersionB': Information on clicked links for a particular version
  -> AbTestCampaignResultClickedLinks
mkAbTestCampaignResultClickedLinks abTestCampaignResultClickedLinksVersionA abTestCampaignResultClickedLinksVersionB =
  AbTestCampaignResultClickedLinks
  { abTestCampaignResultClickedLinksVersionA
  , abTestCampaignResultClickedLinksVersionB
  }

-- ** AbTestCampaignResultStatistics
-- | AbTestCampaignResultStatistics
data AbTestCampaignResultStatistics = AbTestCampaignResultStatistics
  { abTestCampaignResultStatisticsOpeners :: !(AbTestVersionStats) -- ^ /Required/ "openers"
  , abTestCampaignResultStatisticsClicks :: !(AbTestVersionStats) -- ^ /Required/ "clicks"
  , abTestCampaignResultStatisticsUnsubscribed :: !(AbTestVersionStats) -- ^ /Required/ "unsubscribed"
  , abTestCampaignResultStatisticsHardBounces :: !(AbTestVersionStats) -- ^ /Required/ "hardBounces"
  , abTestCampaignResultStatisticsSoftBounces :: !(AbTestVersionStats) -- ^ /Required/ "softBounces"
  , abTestCampaignResultStatisticsComplaints :: !(AbTestVersionStats) -- ^ /Required/ "complaints"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON AbTestCampaignResultStatistics
instance A.FromJSON AbTestCampaignResultStatistics where
  parseJSON = A.withObject "AbTestCampaignResultStatistics" $ \o ->
    AbTestCampaignResultStatistics
      <$> (o .:  "openers")
      <*> (o .:  "clicks")
      <*> (o .:  "unsubscribed")
...
-- | ToJSON AbTestCampaignResultStatistics
instance A.ToJSON AbTestCampaignResultStatistics where
  toJSON AbTestCampaignResultStatistics {..} =
   _omitNulls
      [ "openers" .= abTestCampaignResultStatisticsOpeners
      , "clicks" .= abTestCampaignResultStatisticsClicks
      , "unsubscribed" .= abTestCampaignResultStatisticsUnsubscribed
      , "hardBounces" .= abTestCampaignResultStatisticsHardBounces
      , "softBounces" .= abTestCampaignResultStatisticsSoftBounces
      , "complaints" .= abTestCampaignResultStatisticsComplaints
      ]


-- | Construct a value of type 'AbTestCampaignResultStatistics' (by applying it's required fields, if any)
mkAbTestCampaignResultStatistics
  :: AbTestVersionStats -- ^ 'abTestCampaignResultStatisticsOpeners' 
  -> AbTestVersionStats -- ^ 'abTestCampaignResultStatisticsClicks' 
  -> AbTestVersionStats -- ^ 'abTestCampaignResultStatisticsUnsubscribed' 
  -> AbTestVersionStats -- ^ 'abTestCampaignResultStatisticsHardBounces' 
  -> AbTestVersionStats -- ^ 'abTestCampaignResultStatisticsSoftBounces' 
  -> AbTestVersionStats -- ^ 'abTestCampaignResultStatisticsComplaints' 
  -> AbTestCampaignResultStatistics
mkAbTestCampaignResultStatistics abTestCampaignResultStatisticsOpeners abTestCampaignResultStatisticsClicks abTestCampaignResultStatisticsUnsubscribed abTestCampaignResultStatisticsHardBounces abTestCampaignResultStatisticsSoftBounces abTestCampaignResultStatisticsComplaints =
  AbTestCampaignResultStatistics
  { abTestCampaignResultStatisticsOpeners
  , abTestCampaignResultStatisticsClicks
  , abTestCampaignResultStatisticsUnsubscribed
  , abTestCampaignResultStatisticsHardBounces
  , abTestCampaignResultStatisticsSoftBounces
  , abTestCampaignResultStatisticsComplaints
  }

-- ** AbTestVersionStats
-- | AbTestVersionStats
-- Percentage of a particular event for both versions
data AbTestVersionStats = AbTestVersionStats
  { abTestVersionStatsVersionA :: !(Text) -- ^ /Required/ "Version A" - percentage of an event for version A
  , abTestVersionStatsVersionB :: !(Text) -- ^ /Required/ "Version B" - percentage of an event for version B
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON AbTestVersionStats
instance A.FromJSON AbTestVersionStats where
  parseJSON = A.withObject "AbTestVersionStats" $ \o ->
    AbTestVersionStats
      <$> (o .:  "Version A")
      <*> (o .:  "Version B")

-- | ToJSON AbTestVersionStats
instance A.ToJSON AbTestVersionStats where
  toJSON AbTestVersionStats {..} =
   _omitNulls
      [ "Version A" .= abTestVersionStatsVersionA
      , "Version B" .= abTestVersionStatsVersionB
      ]


-- | Construct a value of type 'AbTestVersionStats' (by applying it's required fields, if any)
mkAbTestVersionStats
  :: Text -- ^ 'abTestVersionStatsVersionA': percentage of an event for version A
  -> Text -- ^ 'abTestVersionStatsVersionB': percentage of an event for version B
  -> AbTestVersionStats
mkAbTestVersionStats abTestVersionStatsVersionA abTestVersionStatsVersionB =
  AbTestVersionStats
  { abTestVersionStatsVersionA
  , abTestVersionStatsVersionB
  }
...
data AddContactToList = AddContactToList
  { addContactToListEmails :: !(Maybe [Text]) -- ^ "emails" - Emails to add to a list. You can pass a maximum of 150 emails for addition in one request. If you need to add the emails in bulk, please prefer /contacts/import api.
  } deriving (P.Show, P.Eq, P.Typeable)
...
-- ** BlockDomain
-- | BlockDomain
data BlockDomain = BlockDomain
  { blockDomainDomain :: !(Text) -- ^ /Required/ "domain" - name of the domain to be blocked
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON BlockDomain
instance A.FromJSON BlockDomain where
  parseJSON = A.withObject "BlockDomain" $ \o ->
    BlockDomain
      <$> (o .:  "domain")

-- | ToJSON BlockDomain
instance A.ToJSON BlockDomain where
  toJSON BlockDomain {..} =
   _omitNulls
      [ "domain" .= blockDomainDomain
      ]


-- | Construct a value of type 'BlockDomain' (by applying it's required fields, if any)
mkBlockDomain
  :: Text -- ^ 'blockDomainDomain': name of the domain to be blocked
  -> BlockDomain
mkBlockDomain blockDomainDomain =
  BlockDomain
  { blockDomainDomain
  }
...
data CreateChild = CreateChild
  ...
  , createChildLanguage :: !(Maybe E'Language) -- ^ "language" - Language of the child account
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkCreateChild createChildEmail createChildFirstName createChildLastName createChildCompanyName createChildPassword =
  ...
  , createChildPassword
  , createChildLanguage = Nothing
  }

-- ** CreateContact
-- | CreateContact
data CreateContact = CreateContact
  { createContactEmail :: !(Maybe Text) -- ^ "email" - Email address of the user. Mandatory if \&quot;SMS\&quot; field is not passed in \&quot;attributes\&quot; parameter. Mobile Number in \&quot;SMS\&quot; field should be passed with proper country code. For example {\&quot;SMS\&quot;:\&quot;+91xxxxxxxxxx\&quot;} or {\&quot;SMS\&quot;:\&quot;0091xxxxxxxxxx\&quot;}
...
-- ** CreateDoiContact
-- | CreateDoiContact
data CreateDoiContact = CreateDoiContact
  { createDoiContactEmail :: !(Text) -- ^ /Required/ "email" - Email address where the confirmation email will be sent. This email address will be the identifier for all other contact attributes.
  , createDoiContactAttributes :: !(Maybe A.Value) -- ^ "attributes" - Pass the set of attributes and their values. These attributes must be present in your SendinBlue account. For eg. {&#39;FNAME&#39;:&#39;Elly&#39;, &#39;LNAME&#39;:&#39;Roger&#39;}
  , createDoiContactIncludeListIds :: !([Integer]) -- ^ /Required/ "includeListIds" - Lists under user account where contact should be added
  , createDoiContactExcludeListIds :: !(Maybe [Integer]) -- ^ "excludeListIds" - Lists under user account where contact should not be added
  , createDoiContactTemplateId :: !(Integer) -- ^ /Required/ "templateId" - Id of the Double opt-in (DOI) template
  , createDoiContactRedirectionUrl :: !(Text) -- ^ /Required/ "redirectionUrl" - URL of the web page that user will be redirected to after clicking on the double opt in URL. When editing your DOI template you can reference this URL by using the tag {{ params.DOIurl }}.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON CreateDoiContact
instance A.FromJSON CreateDoiContact where
  parseJSON = A.withObject "CreateDoiContact" $ \o ->
    CreateDoiContact
      <$> (o .:  "email")
      <*> (o .:? "attributes")
      <*> (o .:  "includeListIds")
...
-- | ToJSON CreateDoiContact
instance A.ToJSON CreateDoiContact where
  toJSON CreateDoiContact {..} =
   _omitNulls
      [ "email" .= createDoiContactEmail
      , "attributes" .= createDoiContactAttributes
      , "includeListIds" .= createDoiContactIncludeListIds
      , "excludeListIds" .= createDoiContactExcludeListIds
      , "templateId" .= createDoiContactTemplateId
      , "redirectionUrl" .= createDoiContactRedirectionUrl
      ]


-- | Construct a value of type 'CreateDoiContact' (by applying it's required fields, if any)
mkCreateDoiContact
  :: Text -- ^ 'createDoiContactEmail': Email address where the confirmation email will be sent. This email address will be the identifier for all other contact attributes.
  -> [Integer] -- ^ 'createDoiContactIncludeListIds': Lists under user account where contact should be added
  -> Integer -- ^ 'createDoiContactTemplateId': Id of the Double opt-in (DOI) template
  -> Text -- ^ 'createDoiContactRedirectionUrl': URL of the web page that user will be redirected to after clicking on the double opt in URL. When editing your DOI template you can reference this URL by using the tag {{ params.DOIurl }}.
  -> CreateDoiContact
mkCreateDoiContact createDoiContactEmail createDoiContactIncludeListIds createDoiContactTemplateId createDoiContactRedirectionUrl =
  CreateDoiContact
  { createDoiContactEmail
  , createDoiContactAttributes = Nothing
  , createDoiContactIncludeListIds
  , createDoiContactExcludeListIds = Nothing
  , createDoiContactTemplateId
  , createDoiContactRedirectionUrl
  }
...
data CreateReseller = CreateReseller
  ...
  , createResellerId :: !(Maybe Integer) -- ^ "id" - Id of Reseller child created
  } deriving (P.Show, P.Eq, P.Typeable)
...
data CreateSender = CreateSender
  ...
  , createSenderEmail :: !(Text) -- ^ /Required/ "email" - From email to use for the sender. A verification email will be sent to this address.
...
mkCreateSender
  ...
  -> Text -- ^ 'createSenderEmail': From email to use for the sender. A verification email will be sent to this address.
  -> CreateSender
...
data CreateSmsCampaign = CreateSmsCampaign
  ...
  , createSmsCampaignSender :: !(Text) -- ^ /Required/ "sender" - Name of the sender. **The number of characters is limited to 11 for alphanumeric characters and 15 for numeric characters**
...
mkCreateSmsCampaign
  ...
  -> Text -- ^ 'createSmsCampaignSender': Name of the sender. **The number of characters is limited to 11 for alphanumeric characters and 15 for numeric characters**
...
data CreateWebhook = CreateWebhook
  ...
  , createWebhookEvents :: !([E'Events]) -- ^ /Required/ "events" - Events triggering the webhook. Possible values for Transactional type webhook – &#x60;sent&#x60; OR &#x60;request&#x60;, &#x60;delivered&#x60;, &#x60;hardBounce&#x60;, &#x60;softBounce&#x60;, &#x60;blocked&#x60;, &#x60;spam&#x60;, &#x60;invalid&#x60;, &#x60;deferred&#x60;, &#x60;click&#x60;, &#x60;opened&#x60;, &#x60;uniqueOpened&#x60; and &#x60;unsubscribed&#x60; and possible values for Marketing type webhook – &#x60;spam&#x60;, &#x60;opened&#x60;, &#x60;click&#x60;, &#x60;hardBounce&#x60;, &#x60;softBounce&#x60;, &#x60;unsubscribed&#x60;, &#x60;listAddition&#x60; &amp; &#x60;delivered&#x60;
...
mkCreateWebhook
  ...
  -> [E'Events] -- ^ 'createWebhookEvents': Events triggering the webhook. Possible values for Transactional type webhook – `sent` OR `request`, `delivered`, `hardBounce`, `softBounce`, `blocked`, `spam`, `invalid`, `deferred`, `click`, `opened`, `uniqueOpened` and `unsubscribed` and possible values for Marketing type webhook – `spam`, `opened`, `click`, `hardBounce`, `softBounce`, `unsubscribed`, `listAddition` & `delivered`
  -> CreateWebhook
...
data EmailExportRecipients = EmailExportRecipients
  { emailExportRecipientsNotifyUrl :: !(Maybe Text) -- ^ "notifyURL" - Webhook called once the export process is finished. For reference, https://help.sendinblue.com/hc/en-us/articles/360007666479
...
data GetAccount = GetAccount
  ...
  , getAccountAddress :: !(GetExtendedClientAllOfAddress) -- ^ /Required/ "address"
  , getAccountPlan :: !([GetAccountAllOfPlan]) -- ^ /Required/ "plan" - Information about your plans and credits
  , getAccountRelay :: !(GetAccountAllOfRelay) -- ^ /Required/ "relay"
  , getAccountMarketingAutomation :: !(Maybe GetAccountAllOfMarketingAutomation) -- ^ "marketingAutomation"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetAccount
  ...
  -> GetExtendedClientAllOfAddress -- ^ 'getAccountAddress' 
  -> [GetAccountAllOfPlan] -- ^ 'getAccountPlan': Information about your plans and credits
  -> GetAccountAllOfRelay -- ^ 'getAccountRelay' 
  -> GetAccount
...
-- ** GetAccountAllOf
-- | GetAccountAllOf
data GetAccountAllOf = GetAccountAllOf
  { getAccountAllOfPlan :: !([GetAccountAllOfPlan]) -- ^ /Required/ "plan" - Information about your plans and credits
  , getAccountAllOfRelay :: !(GetAccountAllOfRelay) -- ^ /Required/ "relay"
  , getAccountAllOfMarketingAutomation :: !(Maybe GetAccountAllOfMarketingAutomation) -- ^ "marketingAutomation"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetAccountAllOf
instance A.FromJSON GetAccountAllOf where
  parseJSON = A.withObject "GetAccountAllOf" $ \o ->
    GetAccountAllOf
      <$> (o .:  "plan")
      <*> (o .:  "relay")
      <*> (o .:? "marketingAutomation")

-- | ToJSON GetAccountAllOf
instance A.ToJSON GetAccountAllOf where
  toJSON GetAccountAllOf {..} =
   _omitNulls
      [ "plan" .= getAccountAllOfPlan
      , "relay" .= getAccountAllOfRelay
      , "marketingAutomation" .= getAccountAllOfMarketingAutomation
      ]


-- | Construct a value of type 'GetAccountAllOf' (by applying it's required fields, if any)
mkGetAccountAllOf
  :: [GetAccountAllOfPlan] -- ^ 'getAccountAllOfPlan': Information about your plans and credits
  -> GetAccountAllOfRelay -- ^ 'getAccountAllOfRelay' 
  -> GetAccountAllOf
mkGetAccountAllOf getAccountAllOfPlan getAccountAllOfRelay =
  GetAccountAllOf
  { getAccountAllOfPlan
  , getAccountAllOfRelay
  , getAccountAllOfMarketingAutomation = Nothing
  }

-- ** GetAccountAllOfMarketingAutomation
-- | GetAccountAllOfMarketingAutomation
data GetAccountAllOfMarketingAutomation = GetAccountAllOfMarketingAutomation
  { getAccountAllOfMarketingAutomationKey :: !(Maybe Text) -- ^ "key" - Marketing Automation Tracker ID
  , getAccountAllOfMarketingAutomationEnabled :: !(Bool) -- ^ /Required/ "enabled" - Status of Marketing Automation Plateform activation for your account (true&#x3D;enabled, false&#x3D;disabled)
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetAccountAllOfMarketingAutomation
instance A.FromJSON GetAccountAllOfMarketingAutomation where
  parseJSON = A.withObject "GetAccountAllOfMarketingAutomation" $ \o ->
    GetAccountAllOfMarketingAutomation
      <$> (o .:? "key")
      <*> (o .:  "enabled")

-- | ToJSON GetAccountAllOfMarketingAutomation
instance A.ToJSON GetAccountAllOfMarketingAutomation where
  toJSON GetAccountAllOfMarketingAutomation {..} =
   _omitNulls
      [ "key" .= getAccountAllOfMarketingAutomationKey
      , "enabled" .= getAccountAllOfMarketingAutomationEnabled
      ]


-- | Construct a value of type 'GetAccountAllOfMarketingAutomation' (by applying it's required fields, if any)
mkGetAccountAllOfMarketingAutomation
  :: Bool -- ^ 'getAccountAllOfMarketingAutomationEnabled': Status of Marketing Automation Plateform activation for your account (true=enabled, false=disabled)
  -> GetAccountAllOfMarketingAutomation
mkGetAccountAllOfMarketingAutomation getAccountAllOfMarketingAutomationEnabled =
  GetAccountAllOfMarketingAutomation
  { getAccountAllOfMarketingAutomationKey = Nothing
  , getAccountAllOfMarketingAutomationEnabled
  }

-- ** GetAccountAllOfPlan
-- | GetAccountAllOfPlan
data GetAccountAllOfPlan = GetAccountAllOfPlan
  { getAccountAllOfPlanType :: !(E'Type5) -- ^ /Required/ "type" - Displays the plan type of the user
  , getAccountAllOfPlanCreditsType :: !(E'CreditsType) -- ^ /Required/ "creditsType" - This is the type of the credit, \&quot;Send Limit\&quot; is one of the possible types of credit of a user. \&quot;Send Limit\&quot; implies the total number of emails you can send to the subscribers in your account.
  , getAccountAllOfPlanCredits :: !(Float) -- ^ /Required/ "credits" - Remaining credits of the user
  , getAccountAllOfPlanStartDate :: !(Maybe Date) -- ^ "startDate" - Date of the period from which the plan will start (only available for \&quot;subscription\&quot; and \&quot;reseller\&quot; plan type)
  , getAccountAllOfPlanEndDate :: !(Maybe Date) -- ^ "endDate" - Date of the period from which the plan will end (only available for \&quot;subscription\&quot; and \&quot;reseller\&quot; plan type)
  , getAccountAllOfPlanUserLimit :: !(Maybe Int) -- ^ "userLimit" - Only in case of reseller account. It implies the total number of child accounts you can add to your account.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetAccountAllOfPlan
instance A.FromJSON GetAccountAllOfPlan where
  parseJSON = A.withObject "GetAccountAllOfPlan" $ \o ->
    GetAccountAllOfPlan
      <$> (o .:  "type")
      <*> (o .:  "creditsType")
      <*> (o .:  "credits")
...
-- | ToJSON GetAccountAllOfPlan
instance A.ToJSON GetAccountAllOfPlan where
  toJSON GetAccountAllOfPlan {..} =
   _omitNulls
      [ "type" .= getAccountAllOfPlanType
      , "creditsType" .= getAccountAllOfPlanCreditsType
      , "credits" .= getAccountAllOfPlanCredits
      , "startDate" .= getAccountAllOfPlanStartDate
      , "endDate" .= getAccountAllOfPlanEndDate
      , "userLimit" .= getAccountAllOfPlanUserLimit
      ]


-- | Construct a value of type 'GetAccountAllOfPlan' (by applying it's required fields, if any)
mkGetAccountAllOfPlan
  :: E'Type5 -- ^ 'getAccountAllOfPlanType': Displays the plan type of the user
  -> E'CreditsType -- ^ 'getAccountAllOfPlanCreditsType': This is the type of the credit, \"Send Limit\" is one of the possible types of credit of a user. \"Send Limit\" implies the total number of emails you can send to the subscribers in your account.
  -> Float -- ^ 'getAccountAllOfPlanCredits': Remaining credits of the user
  -> GetAccountAllOfPlan
mkGetAccountAllOfPlan getAccountAllOfPlanType getAccountAllOfPlanCreditsType getAccountAllOfPlanCredits =
  GetAccountAllOfPlan
  { getAccountAllOfPlanType
  , getAccountAllOfPlanCreditsType
  , getAccountAllOfPlanCredits
  , getAccountAllOfPlanStartDate = Nothing
  , getAccountAllOfPlanEndDate = Nothing
  , getAccountAllOfPlanUserLimit = Nothing
  }

-- ** GetAccountAllOfRelay
-- | GetAccountAllOfRelay
-- Information about your transactional email account
data GetAccountAllOfRelay = GetAccountAllOfRelay
  { getAccountAllOfRelayEnabled :: !(Bool) -- ^ /Required/ "enabled" - Status of your transactional email Account (true&#x3D;Enabled, false&#x3D;Disabled)
  , getAccountAllOfRelayData :: !(GetAccountAllOfRelayData) -- ^ /Required/ "data"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetAccountAllOfRelay
instance A.FromJSON GetAccountAllOfRelay where
  parseJSON = A.withObject "GetAccountAllOfRelay" $ \o ->
    GetAccountAllOfRelay
      <$> (o .:  "enabled")
      <*> (o .:  "data")

-- | ToJSON GetAccountAllOfRelay
instance A.ToJSON GetAccountAllOfRelay where
  toJSON GetAccountAllOfRelay {..} =
   _omitNulls
      [ "enabled" .= getAccountAllOfRelayEnabled
      , "data" .= getAccountAllOfRelayData
      ]


-- | Construct a value of type 'GetAccountAllOfRelay' (by applying it's required fields, if any)
mkGetAccountAllOfRelay
  :: Bool -- ^ 'getAccountAllOfRelayEnabled': Status of your transactional email Account (true=Enabled, false=Disabled)
  -> GetAccountAllOfRelayData -- ^ 'getAccountAllOfRelayData' 
  -> GetAccountAllOfRelay
mkGetAccountAllOfRelay getAccountAllOfRelayEnabled getAccountAllOfRelayData =
  GetAccountAllOfRelay
  { getAccountAllOfRelayEnabled
...
data GetAccountAllOfRelayData = GetAccountAllOfRelayData
  { getAccountAllOfRelayDataUserName :: !(Text) -- ^ /Required/ "userName" - Email to use as login on transactional platform
  , getAccountAllOfRelayDataRelay :: !(Text) -- ^ /Required/ "relay" - URL of the SMTP Relay
  , getAccountAllOfRelayDataPort :: !(Int) -- ^ /Required/ "port" - Port used for SMTP Relay
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetAccountAllOfRelayData
instance A.FromJSON GetAccountAllOfRelayData where
  parseJSON = A.withObject "GetAccountAllOfRelayData" $ \o ->
    GetAccountAllOfRelayData
      <$> (o .:  "userName")
      <*> (o .:  "relay")
      <*> (o .:  "port")

-- | ToJSON GetAccountAllOfRelayData
instance A.ToJSON GetAccountAllOfRelayData where
  toJSON GetAccountAllOfRelayData {..} =
   _omitNulls
      [ "userName" .= getAccountAllOfRelayDataUserName
      , "relay" .= getAccountAllOfRelayDataRelay
      , "port" .= getAccountAllOfRelayDataPort
      ]


-- | Construct a value of type 'GetAccountAllOfRelayData' (by applying it's required fields, if any)
mkGetAccountAllOfRelayData
  :: Text -- ^ 'getAccountAllOfRelayDataUserName': Email to use as login on transactional platform
  -> Text -- ^ 'getAccountAllOfRelayDataRelay': URL of the SMTP Relay
  -> Int -- ^ 'getAccountAllOfRelayDataPort': Port used for SMTP Relay
  -> GetAccountAllOfRelayData
mkGetAccountAllOfRelayData getAccountAllOfRelayDataUserName getAccountAllOfRelayDataRelay getAccountAllOfRelayDataPort =
  GetAccountAllOfRelayData
  { getAccountAllOfRelayDataUserName
  , getAccountAllOfRelayDataRelay
  , getAccountAllOfRelayDataPort
  }
...
data GetBlockedDomains = GetBlockedDomains
  { getBlockedDomainsDomains :: !([Text]) -- ^ /Required/ "domains" - List of all blocked domains
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetBlockedDomains
instance A.FromJSON GetBlockedDomains where
  parseJSON = A.withObject "GetBlockedDomains" $ \o ->
    GetBlockedDomains
      <$> (o .:  "domains")

-- | ToJSON GetBlockedDomains
instance A.ToJSON GetBlockedDomains where
  toJSON GetBlockedDomains {..} =
   _omitNulls
      [ "domains" .= getBlockedDomainsDomains
      ]


-- | Construct a value of type 'GetBlockedDomains' (by applying it's required fields, if any)
mkGetBlockedDomains
  :: [Text] -- ^ 'getBlockedDomainsDomains': List of all blocked domains
  -> GetBlockedDomains
mkGetBlockedDomains getBlockedDomainsDomains =
  GetBlockedDomains
  { getBlockedDomainsDomains
  }
...
data GetCampaignStats = GetCampaignStats
  ...
  , getCampaignStatsReturnBounce :: !(Maybe Integer) -- ^ "returnBounce" - Total number of non-delivered campaigns for a particular campaign id.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON GetCampaignStats where
  toJSON GetCampaignStats {..} =
   _omitNulls
      ...
      , "returnBounce" .= getCampaignStatsReturnBounce
      ]
...
mkGetCampaignStats getCampaignStatsUniqueClicks getCampaignStatsClickers getCampaignStatsComplaints getCampaignStatsDelivered getCampaignStatsSent getCampaignStatsSoftBounces getCampaignStatsHardBounces getCampaignStatsUniqueViews getCampaignStatsUnsubscriptions getCampaignStatsViewed =
  ...
  , getCampaignStatsReturnBounce = Nothing
  }
...
data GetChildInfo = GetChildInfo
  ...
  , getChildInfoCredits :: !(Maybe GetChildInfoAllOfCredits) -- ^ "credits"
  , getChildInfoStatistics :: !(Maybe GetChildInfoAllOfStatistics) -- ^ "statistics"
  ...
  , getChildInfoApiKeys :: !(Maybe GetChildInfoAllOfApiKeys) -- ^ "apiKeys"
  } deriving (P.Show, P.Eq, P.Typeable)
...
-- ** GetChildInfoAllOf
-- | GetChildInfoAllOf
data GetChildInfoAllOf = GetChildInfoAllOf
  { getChildInfoAllOfCredits :: !(Maybe GetChildInfoAllOfCredits) -- ^ "credits"
  , getChildInfoAllOfStatistics :: !(Maybe GetChildInfoAllOfStatistics) -- ^ "statistics"
  , getChildInfoAllOfPassword :: !(Text) -- ^ /Required/ "password" - The encrypted password of child account
  , getChildInfoAllOfIps :: !(Maybe [Text]) -- ^ "ips" - IP(s) associated to a child account user
  , getChildInfoAllOfApiKeys :: !(Maybe GetChildInfoAllOfApiKeys) -- ^ "apiKeys"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetChildInfoAllOf
instance A.FromJSON GetChildInfoAllOf where
  parseJSON = A.withObject "GetChildInfoAllOf" $ \o ->
    GetChildInfoAllOf
      <$> (o .:? "credits")
      <*> (o .:? "statistics")
      <*> (o .:  "password")
...
-- | ToJSON GetChildInfoAllOf
instance A.ToJSON GetChildInfoAllOf where
  toJSON GetChildInfoAllOf {..} =
   _omitNulls
      [ "credits" .= getChildInfoAllOfCredits
      , "statistics" .= getChildInfoAllOfStatistics
      , "password" .= getChildInfoAllOfPassword
      , "ips" .= getChildInfoAllOfIps
      , "apiKeys" .= getChildInfoAllOfApiKeys
      ]


-- | Construct a value of type 'GetChildInfoAllOf' (by applying it's required fields, if any)
mkGetChildInfoAllOf
  :: Text -- ^ 'getChildInfoAllOfPassword': The encrypted password of child account
  -> GetChildInfoAllOf
mkGetChildInfoAllOf getChildInfoAllOfPassword =
  GetChildInfoAllOf
  { getChildInfoAllOfCredits = Nothing
  , getChildInfoAllOfStatistics = Nothing
  , getChildInfoAllOfPassword
  , getChildInfoAllOfIps = Nothing
  , getChildInfoAllOfApiKeys = Nothing
  }

-- ** GetChildInfoAllOfApiKeys
-- | GetChildInfoAllOfApiKeys
-- API Keys associated to child account
data GetChildInfoAllOfApiKeys = GetChildInfoAllOfApiKeys
  { getChildInfoAllOfApiKeysV2 :: !([GetChildInfoAllOfApiKeysV2]) -- ^ /Required/ "v2"
  , getChildInfoAllOfApiKeysV3 :: !(Maybe [GetChildInfoAllOfApiKeysV3]) -- ^ "v3"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetChildInfoAllOfApiKeys
instance A.FromJSON GetChildInfoAllOfApiKeys where
  parseJSON = A.withObject "GetChildInfoAllOfApiKeys" $ \o ->
    GetChildInfoAllOfApiKeys
      <$> (o .:  "v2")
      <*> (o .:? "v3")

-- | ToJSON GetChildInfoAllOfApiKeys
instance A.ToJSON GetChildInfoAllOfApiKeys where
  toJSON GetChildInfoAllOfApiKeys {..} =
   _omitNulls
      [ "v2" .= getChildInfoAllOfApiKeysV2
      , "v3" .= getChildInfoAllOfApiKeysV3
      ]


-- | Construct a value of type 'GetChildInfoAllOfApiKeys' (by applying it's required fields, if any)
mkGetChildInfoAllOfApiKeys
  :: [GetChildInfoAllOfApiKeysV2] -- ^ 'getChildInfoAllOfApiKeysV2' 
  -> GetChildInfoAllOfApiKeys
mkGetChildInfoAllOfApiKeys getChildInfoAllOfApiKeysV2 =
  GetChildInfoAllOfApiKeys
  { getChildInfoAllOfApiKeysV2
  , getChildInfoAllOfApiKeysV3 = Nothing
  }

-- ** GetChildInfoAllOfApiKeysV2
-- | GetChildInfoAllOfApiKeysV2
data GetChildInfoAllOfApiKeysV2 = GetChildInfoAllOfApiKeysV2
  { getChildInfoAllOfApiKeysV2Name :: !(Text) -- ^ /Required/ "name" - Name of the key for version 2
  , getChildInfoAllOfApiKeysV2Key :: !(Text) -- ^ /Required/ "key" - API Key for version 2
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetChildInfoAllOfApiKeysV2
instance A.FromJSON GetChildInfoAllOfApiKeysV2 where
  parseJSON = A.withObject "GetChildInfoAllOfApiKeysV2" $ \o ->
    GetChildInfoAllOfApiKeysV2
      <$> (o .:  "name")
      <*> (o .:  "key")

-- | ToJSON GetChildInfoAllOfApiKeysV2
instance A.ToJSON GetChildInfoAllOfApiKeysV2 where
  toJSON GetChildInfoAllOfApiKeysV2 {..} =
   _omitNulls
      [ "name" .= getChildInfoAllOfApiKeysV2Name
      , "key" .= getChildInfoAllOfApiKeysV2Key
      ]


-- | Construct a value of type 'GetChildInfoAllOfApiKeysV2' (by applying it's required fields, if any)
mkGetChildInfoAllOfApiKeysV2
  :: Text -- ^ 'getChildInfoAllOfApiKeysV2Name': Name of the key for version 2
  -> Text -- ^ 'getChildInfoAllOfApiKeysV2Key': API Key for version 2
  -> GetChildInfoAllOfApiKeysV2
mkGetChildInfoAllOfApiKeysV2 getChildInfoAllOfApiKeysV2Name getChildInfoAllOfApiKeysV2Key =
  GetChildInfoAllOfApiKeysV2
  { getChildInfoAllOfApiKeysV2Name
  , getChildInfoAllOfApiKeysV2Key
  }

-- ** GetChildInfoAllOfApiKeysV3
-- | GetChildInfoAllOfApiKeysV3
data GetChildInfoAllOfApiKeysV3 = GetChildInfoAllOfApiKeysV3
  { getChildInfoAllOfApiKeysV3Name :: !(Text) -- ^ /Required/ "name" - Name of the key for version 3
  , getChildInfoAllOfApiKeysV3Key :: !(Text) -- ^ /Required/ "key" - API Key for version 3
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetChildInfoAllOfApiKeysV3
instance A.FromJSON GetChildInfoAllOfApiKeysV3 where
  parseJSON = A.withObject "GetChildInfoAllOfApiKeysV3" $ \o ->
    GetChildInfoAllOfApiKeysV3
      <$> (o .:  "name")
      <*> (o .:  "key")

-- | ToJSON GetChildInfoAllOfApiKeysV3
instance A.ToJSON GetChildInfoAllOfApiKeysV3 where
  toJSON GetChildInfoAllOfApiKeysV3 {..} =
   _omitNulls
      [ "name" .= getChildInfoAllOfApiKeysV3Name
      , "key" .= getChildInfoAllOfApiKeysV3Key
      ]


-- | Construct a value of type 'GetChildInfoAllOfApiKeysV3' (by applying it's required fields, if any)
mkGetChildInfoAllOfApiKeysV3
  :: Text -- ^ 'getChildInfoAllOfApiKeysV3Name': Name of the key for version 3
  -> Text -- ^ 'getChildInfoAllOfApiKeysV3Key': API Key for version 3
  -> GetChildInfoAllOfApiKeysV3
mkGetChildInfoAllOfApiKeysV3 getChildInfoAllOfApiKeysV3Name getChildInfoAllOfApiKeysV3Key =
  GetChildInfoAllOfApiKeysV3
  { getChildInfoAllOfApiKeysV3Name
  , getChildInfoAllOfApiKeysV3Key
  }

-- ** GetChildInfoAllOfCredits
-- | GetChildInfoAllOfCredits
-- Credits available for your child
data GetChildInfoAllOfCredits = GetChildInfoAllOfCredits
  { getChildInfoAllOfCreditsEmailCredits :: !(Maybe Integer) -- ^ "emailCredits" - Email credits available for your child
  , getChildInfoAllOfCreditsSmsCredits :: !(Maybe Integer) -- ^ "smsCredits" - SMS credits available for your child
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetChildInfoAllOfCredits
instance A.FromJSON GetChildInfoAllOfCredits where
  parseJSON = A.withObject "GetChildInfoAllOfCredits" $ \o ->
    GetChildInfoAllOfCredits
      <$> (o .:? "emailCredits")
      <*> (o .:? "smsCredits")

-- | ToJSON GetChildInfoAllOfCredits
instance A.ToJSON GetChildInfoAllOfCredits where
  toJSON GetChildInfoAllOfCredits {..} =
   _omitNulls
      [ "emailCredits" .= getChildInfoAllOfCreditsEmailCredits
      , "smsCredits" .= getChildInfoAllOfCreditsSmsCredits
      ]


-- | Construct a value of type 'GetChildInfoAllOfCredits' (by applying it's required fields, if any)
mkGetChildInfoAllOfCredits
  :: GetChildInfoAllOfCredits
mkGetChildInfoAllOfCredits =
  GetChildInfoAllOfCredits
  { getChildInfoAllOfCreditsEmailCredits = Nothing
  , getChildInfoAllOfCreditsSmsCredits = Nothing
  }

-- ** GetChildInfoAllOfStatistics
-- | GetChildInfoAllOfStatistics
-- Statistics about your child account activity
data GetChildInfoAllOfStatistics = GetChildInfoAllOfStatistics
  { getChildInfoAllOfStatisticsPreviousMonthTotalSent :: !(Maybe Integer) -- ^ "previousMonthTotalSent" - Overall emails sent for the previous month
  , getChildInfoAllOfStatisticsCurrentMonthTotalSent :: !(Maybe Integer) -- ^ "currentMonthTotalSent" - Overall emails sent for current month
  , getChildInfoAllOfStatisticsTotalSent :: !(Maybe Integer) -- ^ "totalSent" - Overall emails sent for since the account exists
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetChildInfoAllOfStatistics
instance A.FromJSON GetChildInfoAllOfStatistics where
  parseJSON = A.withObject "GetChildInfoAllOfStatistics" $ \o ->
    GetChildInfoAllOfStatistics
      <$> (o .:? "previousMonthTotalSent")
      <*> (o .:? "currentMonthTotalSent")
      <*> (o .:? "totalSent")

-- | ToJSON GetChildInfoAllOfStatistics
instance A.ToJSON GetChildInfoAllOfStatistics where
  toJSON GetChildInfoAllOfStatistics {..} =
   _omitNulls
      [ "previousMonthTotalSent" .= getChildInfoAllOfStatisticsPreviousMonthTotalSent
      , "currentMonthTotalSent" .= getChildInfoAllOfStatisticsCurrentMonthTotalSent
      , "totalSent" .= getChildInfoAllOfStatisticsTotalSent
      ]


-- | Construct a value of type 'GetChildInfoAllOfStatistics' (by applying it's required fields, if any)
mkGetChildInfoAllOfStatistics
  :: GetChildInfoAllOfStatistics
mkGetChildInfoAllOfStatistics =
  GetChildInfoAllOfStatistics
  { getChildInfoAllOfStatisticsPreviousMonthTotalSent = Nothing
  , getChildInfoAllOfStatisticsCurrentMonthTotalSent = Nothing
  , getChildInfoAllOfStatisticsTotalSent = Nothing
  }

-- ** GetChildrenList
-- | GetChildrenList
data GetChildrenList = GetChildrenList
  { getChildrenListChildren :: !(Maybe [GetChildInfo]) -- ^ "children" - Your children&#39;s account information
...
data GetContactCampaignStats = GetContactCampaignStats
  { getContactCampaignStatsMessagesSent :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "messagesSent"
  , getContactCampaignStatsHardBounces :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "hardBounces"
  , getContactCampaignStatsSoftBounces :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "softBounces"
  , getContactCampaignStatsComplaints :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "complaints"
...
data GetContactCampaignStatsClicked = GetContactCampaignStatsClicked
  ...
  , getContactCampaignStatsClickedLinks :: !([GetExtendedContactDetailsAllOfStatisticsLinks]) -- ^ /Required/ "links"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetContactCampaignStatsClicked
  ...
  -> [GetExtendedContactDetailsAllOfStatisticsLinks] -- ^ 'getContactCampaignStatsClickedLinks' 
  -> GetContactCampaignStatsClicked
...
data GetContactCampaignStatsUnsubscriptions = GetContactCampaignStatsUnsubscriptions
  { getContactCampaignStatsUnsubscriptionsUserUnsubscription :: !([GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription]) -- ^ /Required/ "userUnsubscription" - Contact has unsubscribed via the unsubscription link in the email
  , getContactCampaignStatsUnsubscriptionsAdminUnsubscription :: !([GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription]) -- ^ /Required/ "adminUnsubscription" - Contact has been unsubscribed from the administrator
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetContactCampaignStatsUnsubscriptions
  :: [GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription] -- ^ 'getContactCampaignStatsUnsubscriptionsUserUnsubscription': Contact has unsubscribed via the unsubscription link in the email
  -> [GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription] -- ^ 'getContactCampaignStatsUnsubscriptionsAdminUnsubscription': Contact has been unsubscribed from the administrator
  -> GetContactCampaignStatsUnsubscriptions
...
data GetContacts = GetContacts
  { getContactsContacts :: !([GetContactDetails]) -- ^ /Required/ "contacts"
...
mkGetContacts
  :: [GetContactDetails] -- ^ 'getContactsContacts' 
...
data GetEmailCampaign = GetEmailCampaign
  ...
  , getEmailCampaignSender :: !(GetExtendedCampaignOverviewAllOfSender) -- ^ /Required/ "sender"
  ...
  , getEmailCampaignReturnBounce :: !(Maybe Integer) -- ^ "returnBounce" - Total number of non-delivered campaigns for a particular campaign id.
  , getEmailCampaignRecipients :: !(GetCampaignRecipients) -- ^ /Required/ "recipients"
  , getEmailCampaignStatistics :: !(GetExtendedCampaignStats) -- ^ /Required/ "statistics"
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON GetEmailCampaign where
  toJSON GetEmailCampaign {..} =
   _omitNulls
      ...
      , "returnBounce" .= getEmailCampaignReturnBounce
...
mkGetEmailCampaign
  ...
  -> GetExtendedCampaignOverviewAllOfSender -- ^ 'getEmailCampaignSender' 
  ...
  -> GetCampaignRecipients -- ^ 'getEmailCampaignRecipients' 
  -> GetExtendedCampaignStats -- ^ 'getEmailCampaignStatistics' 
  -> GetEmailCampaign
mkGetEmailCampaign getEmailCampaignId getEmailCampaignName getEmailCampaignType getEmailCampaignStatus getEmailCampaignTestSent getEmailCampaignHeader getEmailCampaignFooter getEmailCampaignSender getEmailCampaignReplyTo getEmailCampaignToField getEmailCampaignHtmlContent getEmailCampaignTag getEmailCampaignCreatedAt getEmailCampaignModifiedAt getEmailCampaignRecipients getEmailCampaignStatistics =
  ...
  , getEmailCampaignReturnBounce = Nothing
...
-- | GetEmailCampaignAllOf
data GetEmailCampaignAllOf = GetEmailCampaignAllOf
  { getEmailCampaignAllOfRecipients :: !(GetCampaignRecipients) -- ^ /Required/ "recipients"
  , getEmailCampaignAllOfStatistics :: !(GetExtendedCampaignStats) -- ^ /Required/ "statistics"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetEmailCampaignAllOf
instance A.FromJSON GetEmailCampaignAllOf where
  parseJSON = A.withObject "GetEmailCampaignAllOf" $ \o ->
    GetEmailCampaignAllOf
      <$> (o .:  "recipients")
      <*> (o .:  "statistics")

-- | ToJSON GetEmailCampaignAllOf
instance A.ToJSON GetEmailCampaignAllOf where
  toJSON GetEmailCampaignAllOf {..} =
   _omitNulls
      [ "recipients" .= getEmailCampaignAllOfRecipients
      , "statistics" .= getEmailCampaignAllOfStatistics
      ]


-- | Construct a value of type 'GetEmailCampaignAllOf' (by applying it's required fields, if any)
mkGetEmailCampaignAllOf
  :: GetCampaignRecipients -- ^ 'getEmailCampaignAllOfRecipients' 
  -> GetExtendedCampaignStats -- ^ 'getEmailCampaignAllOfStatistics' 
  -> GetEmailCampaignAllOf
mkGetEmailCampaignAllOf getEmailCampaignAllOfRecipients getEmailCampaignAllOfStatistics =
  GetEmailCampaignAllOf
  { getEmailCampaignAllOfRecipients
  , getEmailCampaignAllOfStatistics
  }

-- ** GetEmailCampaigns
-- | GetEmailCampaigns
data GetEmailCampaigns = GetEmailCampaigns
  { getEmailCampaignsCampaigns :: !(Maybe [GetExtendedCampaignOverview]) -- ^ "campaigns"
...
data GetExtendedCampaignOverview = GetExtendedCampaignOverview
  ...
  , getExtendedCampaignOverviewSender :: !(GetExtendedCampaignOverviewAllOfSender) -- ^ /Required/ "sender"
  ...
  , getExtendedCampaignOverviewReturnBounce :: !(Maybe Integer) -- ^ "returnBounce" - Total number of non-delivered campaigns for a particular campaign id.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON GetExtendedCampaignOverview where
  toJSON GetExtendedCampaignOverview {..} =
   _omitNulls
      ...
      , "returnBounce" .= getExtendedCampaignOverviewReturnBounce
      ]
...
mkGetExtendedCampaignOverview
  ...
  -> GetExtendedCampaignOverviewAllOfSender -- ^ 'getExtendedCampaignOverviewSender' 
...
mkGetExtendedCampaignOverview getExtendedCampaignOverviewId getExtendedCampaignOverviewName getExtendedCampaignOverviewType getExtendedCampaignOverviewStatus getExtendedCampaignOverviewTestSent getExtendedCampaignOverviewHeader getExtendedCampaignOverviewFooter getExtendedCampaignOverviewSender getExtendedCampaignOverviewReplyTo getExtendedCampaignOverviewToField getExtendedCampaignOverviewHtmlContent getExtendedCampaignOverviewTag getExtendedCampaignOverviewCreatedAt getExtendedCampaignOverviewModifiedAt =
  ...
  , getExtendedCampaignOverviewReturnBounce = Nothing
  }

-- ** GetExtendedCampaignOverviewAllOf
-- | GetExtendedCampaignOverviewAllOf
data GetExtendedCampaignOverviewAllOf = GetExtendedCampaignOverviewAllOf
  { getExtendedCampaignOverviewAllOfTestSent :: !(Bool) -- ^ /Required/ "testSent" - Retrieved the status of test email sending. (true&#x3D;Test email has been sent  false&#x3D;Test email has not been sent)
  , getExtendedCampaignOverviewAllOfHeader :: !(Text) -- ^ /Required/ "header" - Header of the campaign
  , getExtendedCampaignOverviewAllOfFooter :: !(Text) -- ^ /Required/ "footer" - Footer of the campaign
  , getExtendedCampaignOverviewAllOfSender :: !(GetExtendedCampaignOverviewAllOfSender) -- ^ /Required/ "sender"
  , getExtendedCampaignOverviewAllOfReplyTo :: !(Text) -- ^ /Required/ "replyTo" - Email defined as the \&quot;Reply to\&quot; of the campaign
  , getExtendedCampaignOverviewAllOfToField :: !(Text) -- ^ /Required/ "toField" - Customisation of the \&quot;to\&quot; field of the campaign
  , getExtendedCampaignOverviewAllOfHtmlContent :: !(Text) -- ^ /Required/ "htmlContent" - HTML content of the campaign
  , getExtendedCampaignOverviewAllOfShareLink :: !(Maybe Text) -- ^ "shareLink" - Link to share the campaign on social medias
  , getExtendedCampaignOverviewAllOfTag :: !(Text) -- ^ /Required/ "tag" - Tag of the campaign
  , getExtendedCampaignOverviewAllOfCreatedAt :: !(DateTime) -- ^ /Required/ "createdAt" - Creation UTC date-time of the campaign (YYYY-MM-DDTHH:mm:ss.SSSZ)
  , getExtendedCampaignOverviewAllOfModifiedAt :: !(DateTime) -- ^ /Required/ "modifiedAt" - UTC date-time of last modification of the campaign (YYYY-MM-DDTHH:mm:ss.SSSZ)
  , getExtendedCampaignOverviewAllOfInlineImageActivation :: !(Maybe Bool) -- ^ "inlineImageActivation" - Status of inline image. inlineImageActivation &#x3D; false means image can’t be embedded, &amp; inlineImageActivation &#x3D; true means image can be embedded, in the email.
  , getExtendedCampaignOverviewAllOfMirrorActive :: !(Maybe Bool) -- ^ "mirrorActive" - Status of mirror links in campaign. mirrorActive &#x3D; false means mirror links are deactivated, &amp; mirrorActive &#x3D; true means mirror links are activated, in the campaign
  , getExtendedCampaignOverviewAllOfRecurring :: !(Maybe Bool) -- ^ "recurring" - FOR TRIGGER ONLY ! Type of trigger campaign.recurring &#x3D; false means contact can receive the same Trigger campaign only once, &amp; recurring &#x3D; true means contact can receive the same Trigger campaign several times
  , getExtendedCampaignOverviewAllOfSentDate :: !(Maybe DateTime) -- ^ "sentDate" - Sent UTC date-time of the campaign (YYYY-MM-DDTHH:mm:ss.SSSZ). Only available if &#39;status&#39; of the campaign is &#39;sent&#39;
  , getExtendedCampaignOverviewAllOfReturnBounce :: !(Maybe Integer) -- ^ "returnBounce" - Total number of non-delivered campaigns for a particular campaign id.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedCampaignOverviewAllOf
instance A.FromJSON GetExtendedCampaignOverviewAllOf where
  parseJSON = A.withObject "GetExtendedCampaignOverviewAllOf" $ \o ->
    GetExtendedCampaignOverviewAllOf
      <$> (o .:  "testSent")
      <*> (o .:  "header")
      <*> (o .:  "footer")
...
-- | ToJSON GetExtendedCampaignOverviewAllOf
instance A.ToJSON GetExtendedCampaignOverviewAllOf where
  toJSON GetExtendedCampaignOverviewAllOf {..} =
   _omitNulls
      [ "testSent" .= getExtendedCampaignOverviewAllOfTestSent
      , "header" .= getExtendedCampaignOverviewAllOfHeader
      , "footer" .= getExtendedCampaignOverviewAllOfFooter
      , "sender" .= getExtendedCampaignOverviewAllOfSender
      , "replyTo" .= getExtendedCampaignOverviewAllOfReplyTo
      , "toField" .= getExtendedCampaignOverviewAllOfToField
      , "htmlContent" .= getExtendedCampaignOverviewAllOfHtmlContent
      , "shareLink" .= getExtendedCampaignOverviewAllOfShareLink
      , "tag" .= getExtendedCampaignOverviewAllOfTag
      , "createdAt" .= getExtendedCampaignOverviewAllOfCreatedAt
      , "modifiedAt" .= getExtendedCampaignOverviewAllOfModifiedAt
      , "inlineImageActivation" .= getExtendedCampaignOverviewAllOfInlineImageActivation
      , "mirrorActive" .= getExtendedCampaignOverviewAllOfMirrorActive
      , "recurring" .= getExtendedCampaignOverviewAllOfRecurring
      , "sentDate" .= getExtendedCampaignOverviewAllOfSentDate
      , "returnBounce" .= getExtendedCampaignOverviewAllOfReturnBounce
      ]


-- | Construct a value of type 'GetExtendedCampaignOverviewAllOf' (by applying it's required fields, if any)
mkGetExtendedCampaignOverviewAllOf
  :: Bool -- ^ 'getExtendedCampaignOverviewAllOfTestSent': Retrieved the status of test email sending. (true=Test email has been sent  false=Test email has not been sent)
  -> Text -- ^ 'getExtendedCampaignOverviewAllOfHeader': Header of the campaign
  -> Text -- ^ 'getExtendedCampaignOverviewAllOfFooter': Footer of the campaign
  -> GetExtendedCampaignOverviewAllOfSender -- ^ 'getExtendedCampaignOverviewAllOfSender' 
  -> Text -- ^ 'getExtendedCampaignOverviewAllOfReplyTo': Email defined as the \"Reply to\" of the campaign
  -> Text -- ^ 'getExtendedCampaignOverviewAllOfToField': Customisation of the \"to\" field of the campaign
  -> Text -- ^ 'getExtendedCampaignOverviewAllOfHtmlContent': HTML content of the campaign
  -> Text -- ^ 'getExtendedCampaignOverviewAllOfTag': Tag of the campaign
  -> DateTime -- ^ 'getExtendedCampaignOverviewAllOfCreatedAt': Creation UTC date-time of the campaign (YYYY-MM-DDTHH:mm:ss.SSSZ)
  -> DateTime -- ^ 'getExtendedCampaignOverviewAllOfModifiedAt': UTC date-time of last modification of the campaign (YYYY-MM-DDTHH:mm:ss.SSSZ)
  -> GetExtendedCampaignOverviewAllOf
mkGetExtendedCampaignOverviewAllOf getExtendedCampaignOverviewAllOfTestSent getExtendedCampaignOverviewAllOfHeader getExtendedCampaignOverviewAllOfFooter getExtendedCampaignOverviewAllOfSender getExtendedCampaignOverviewAllOfReplyTo getExtendedCampaignOverviewAllOfToField getExtendedCampaignOverviewAllOfHtmlContent getExtendedCampaignOverviewAllOfTag getExtendedCampaignOverviewAllOfCreatedAt getExtendedCampaignOverviewAllOfModifiedAt =
  GetExtendedCampaignOverviewAllOf
  { getExtendedCampaignOverviewAllOfTestSent
  , getExtendedCampaignOverviewAllOfHeader
  , getExtendedCampaignOverviewAllOfFooter
  , getExtendedCampaignOverviewAllOfSender
  , getExtendedCampaignOverviewAllOfReplyTo
  , getExtendedCampaignOverviewAllOfToField
  , getExtendedCampaignOverviewAllOfHtmlContent
  , getExtendedCampaignOverviewAllOfShareLink = Nothing
  , getExtendedCampaignOverviewAllOfTag
  , getExtendedCampaignOverviewAllOfCreatedAt
  , getExtendedCampaignOverviewAllOfModifiedAt
  , getExtendedCampaignOverviewAllOfInlineImageActivation = Nothing
  , getExtendedCampaignOverviewAllOfMirrorActive = Nothing
  , getExtendedCampaignOverviewAllOfRecurring = Nothing
  , getExtendedCampaignOverviewAllOfSentDate = Nothing
  , getExtendedCampaignOverviewAllOfReturnBounce = Nothing
  }

-- ** GetExtendedCampaignOverviewAllOfSender
-- | GetExtendedCampaignOverviewAllOfSender
data GetExtendedCampaignOverviewAllOfSender = GetExtendedCampaignOverviewAllOfSender
  { getExtendedCampaignOverviewAllOfSenderName :: !(Maybe Text) -- ^ "name" - Sender name of the campaign
  , getExtendedCampaignOverviewAllOfSenderEmail :: !(Maybe Text) -- ^ "email" - Sender email of the campaign
  , getExtendedCampaignOverviewAllOfSenderId :: !(Maybe Text) -- ^ "id" - Sender id of the campaign
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedCampaignOverviewAllOfSender
instance A.FromJSON GetExtendedCampaignOverviewAllOfSender where
  parseJSON = A.withObject "GetExtendedCampaignOverviewAllOfSender" $ \o ->
    GetExtendedCampaignOverviewAllOfSender
      <$> (o .:? "name")
      <*> (o .:? "email")
      <*> (o .:? "id")

-- | ToJSON GetExtendedCampaignOverviewAllOfSender
instance A.ToJSON GetExtendedCampaignOverviewAllOfSender where
  toJSON GetExtendedCampaignOverviewAllOfSender {..} =
   _omitNulls
      [ "name" .= getExtendedCampaignOverviewAllOfSenderName
      , "email" .= getExtendedCampaignOverviewAllOfSenderEmail
      , "id" .= getExtendedCampaignOverviewAllOfSenderId
      ]


-- | Construct a value of type 'GetExtendedCampaignOverviewAllOfSender' (by applying it's required fields, if any)
mkGetExtendedCampaignOverviewAllOfSender
  :: GetExtendedCampaignOverviewAllOfSender
mkGetExtendedCampaignOverviewAllOfSender =
  GetExtendedCampaignOverviewAllOfSender
  { getExtendedCampaignOverviewAllOfSenderName = Nothing
  , getExtendedCampaignOverviewAllOfSenderEmail = Nothing
  , getExtendedCampaignOverviewAllOfSenderId = Nothing
  }

-- ** GetExtendedCampaignStats
-- | GetExtendedCampaignStats
data GetExtendedCampaignStats = GetExtendedCampaignStats
  { getExtendedCampaignStatsGlobalStats :: !(GetCampaignStats) -- ^ /Required/ "globalStats" - Overall statistics of the campaign
  , getExtendedCampaignStatsCampaignStats :: !([GetCampaignStats]) -- ^ /Required/ "campaignStats" - List-wise statistics of the campaign.
  ...
  , getExtendedCampaignStatsStatsByDomain :: !((Map.Map String GetCampaignStats)) -- ^ /Required/ "statsByDomain"
  , getExtendedCampaignStatsStatsByDevice :: !(GetStatsByDevice) -- ^ /Required/ "statsByDevice"
  , getExtendedCampaignStatsStatsByBrowser :: !((Map.Map String GetDeviceBrowserStats)) -- ^ /Required/ "statsByBrowser"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetExtendedCampaignStats
  :: GetCampaignStats -- ^ 'getExtendedCampaignStatsGlobalStats': Overall statistics of the campaign
  -> [GetCampaignStats] -- ^ 'getExtendedCampaignStatsCampaignStats': List-wise statistics of the campaign.
  ...
  -> (Map.Map String GetCampaignStats) -- ^ 'getExtendedCampaignStatsStatsByDomain' 
  -> GetStatsByDevice -- ^ 'getExtendedCampaignStatsStatsByDevice' 
  -> (Map.Map String GetDeviceBrowserStats) -- ^ 'getExtendedCampaignStatsStatsByBrowser' 
  -> GetExtendedCampaignStats
...
data GetExtendedClient = GetExtendedClient
  ...
  , getExtendedClientAddress :: !(GetExtendedClientAllOfAddress) -- ^ /Required/ "address"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetExtendedClient
  ...
  -> GetExtendedClientAllOfAddress -- ^ 'getExtendedClientAddress' 
  -> GetExtendedClient
...
-- | GetExtendedClientAllOf
data GetExtendedClientAllOf = GetExtendedClientAllOf
  { getExtendedClientAllOfAddress :: !(GetExtendedClientAllOfAddress) -- ^ /Required/ "address"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedClientAllOf
instance A.FromJSON GetExtendedClientAllOf where
  parseJSON = A.withObject "GetExtendedClientAllOf" $ \o ->
    GetExtendedClientAllOf
      <$> (o .:  "address")

-- | ToJSON GetExtendedClientAllOf
instance A.ToJSON GetExtendedClientAllOf where
  toJSON GetExtendedClientAllOf {..} =
   _omitNulls
...
-- | Construct a value of type 'GetExtendedClientAllOf' (by applying it's required fields, if any)
mkGetExtendedClientAllOf
  :: GetExtendedClientAllOfAddress -- ^ 'getExtendedClientAllOfAddress' 
  -> GetExtendedClientAllOf
mkGetExtendedClientAllOf getExtendedClientAllOfAddress =
  GetExtendedClientAllOf
...
data GetExtendedClientAllOfAddress = GetExtendedClientAllOfAddress
  { getExtendedClientAllOfAddressStreet :: !(Text) -- ^ /Required/ "street" - Street information
  , getExtendedClientAllOfAddressCity :: !(Text) -- ^ /Required/ "city" - City information
  , getExtendedClientAllOfAddressZipCode :: !(Text) -- ^ /Required/ "zipCode" - Zip Code information
  , getExtendedClientAllOfAddressCountry :: !(Text) -- ^ /Required/ "country" - Country information
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedClientAllOfAddress
instance A.FromJSON GetExtendedClientAllOfAddress where
  parseJSON = A.withObject "GetExtendedClientAllOfAddress" $ \o ->
    GetExtendedClientAllOfAddress
      <$> (o .:  "street")
      <*> (o .:  "city")
      <*> (o .:  "zipCode")
...
-- | ToJSON GetExtendedClientAllOfAddress
instance A.ToJSON GetExtendedClientAllOfAddress where
  toJSON GetExtendedClientAllOfAddress {..} =
   _omitNulls
      [ "street" .= getExtendedClientAllOfAddressStreet
      , "city" .= getExtendedClientAllOfAddressCity
      , "zipCode" .= getExtendedClientAllOfAddressZipCode
      , "country" .= getExtendedClientAllOfAddressCountry
      ]


-- | Construct a value of type 'GetExtendedClientAllOfAddress' (by applying it's required fields, if any)
mkGetExtendedClientAllOfAddress
  :: Text -- ^ 'getExtendedClientAllOfAddressStreet': Street information
  -> Text -- ^ 'getExtendedClientAllOfAddressCity': City information
  -> Text -- ^ 'getExtendedClientAllOfAddressZipCode': Zip Code information
  -> Text -- ^ 'getExtendedClientAllOfAddressCountry': Country information
  -> GetExtendedClientAllOfAddress
mkGetExtendedClientAllOfAddress getExtendedClientAllOfAddressStreet getExtendedClientAllOfAddressCity getExtendedClientAllOfAddressZipCode getExtendedClientAllOfAddressCountry =
  GetExtendedClientAllOfAddress
  { getExtendedClientAllOfAddressStreet
  , getExtendedClientAllOfAddressCity
  , getExtendedClientAllOfAddressZipCode
  , getExtendedClientAllOfAddressCountry
  }
...
data GetExtendedContactDetails = GetExtendedContactDetails
  ...
  , getExtendedContactDetailsStatistics :: !(GetExtendedContactDetailsAllOfStatistics) -- ^ /Required/ "statistics"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetExtendedContactDetails
  ...
  -> GetExtendedContactDetailsAllOfStatistics -- ^ 'getExtendedContactDetailsStatistics' 
  -> GetExtendedContactDetails
...
-- | GetExtendedContactDetailsAllOf
data GetExtendedContactDetailsAllOf = GetExtendedContactDetailsAllOf
  { getExtendedContactDetailsAllOfStatistics :: !(GetExtendedContactDetailsAllOfStatistics) -- ^ /Required/ "statistics"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOf
instance A.FromJSON GetExtendedContactDetailsAllOf where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOf" $ \o ->
    GetExtendedContactDetailsAllOf
      <$> (o .:  "statistics")

-- | ToJSON GetExtendedContactDetailsAllOf
instance A.ToJSON GetExtendedContactDetailsAllOf where
  toJSON GetExtendedContactDetailsAllOf {..} =
   _omitNulls
...
-- | Construct a value of type 'GetExtendedContactDetailsAllOf' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOf
  :: GetExtendedContactDetailsAllOfStatistics -- ^ 'getExtendedContactDetailsAllOfStatistics' 
  -> GetExtendedContactDetailsAllOf
mkGetExtendedContactDetailsAllOf getExtendedContactDetailsAllOfStatistics =
  GetExtendedContactDetailsAllOf
...
data GetExtendedContactDetailsAllOfStatistics = GetExtendedContactDetailsAllOfStatistics
  { getExtendedContactDetailsAllOfStatisticsMessagesSent :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "messagesSent" - Listing of the sent campaign for the contact
  , getExtendedContactDetailsAllOfStatisticsHardBounces :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "hardBounces" - Listing of the hardbounes generated by the contact
  , getExtendedContactDetailsAllOfStatisticsSoftBounces :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "softBounces" - Listing of the softbounes generated by the contact
  , getExtendedContactDetailsAllOfStatisticsComplaints :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsMessagesSent]) -- ^ "complaints" - Listing of the complaints generated by the contact
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptions :: !(Maybe GetExtendedContactDetailsAllOfStatisticsUnsubscriptions) -- ^ "unsubscriptions"
  , getExtendedContactDetailsAllOfStatisticsOpened :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsOpened]) -- ^ "opened" - Listing of the openings generated by the contact
  , getExtendedContactDetailsAllOfStatisticsClicked :: !(Maybe [GetExtendedContactDetailsAllOfStatisticsClicked]) -- ^ "clicked" - Listing of the clicks generated by the contact
  , getExtendedContactDetailsAllOfStatisticsTransacAttributes :: !(Maybe [A.Value]) -- ^ "transacAttributes" - Listing of the transactional attributes for the contact
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatistics
instance A.FromJSON GetExtendedContactDetailsAllOfStatistics where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatistics" $ \o ->
    GetExtendedContactDetailsAllOfStatistics
      <$> (o .:? "messagesSent")
      <*> (o .:? "hardBounces")
      <*> (o .:? "softBounces")
...
-- | ToJSON GetExtendedContactDetailsAllOfStatistics
instance A.ToJSON GetExtendedContactDetailsAllOfStatistics where
  toJSON GetExtendedContactDetailsAllOfStatistics {..} =
   _omitNulls
      [ "messagesSent" .= getExtendedContactDetailsAllOfStatisticsMessagesSent
      , "hardBounces" .= getExtendedContactDetailsAllOfStatisticsHardBounces
      , "softBounces" .= getExtendedContactDetailsAllOfStatisticsSoftBounces
      , "complaints" .= getExtendedContactDetailsAllOfStatisticsComplaints
      , "unsubscriptions" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptions
      , "opened" .= getExtendedContactDetailsAllOfStatisticsOpened
      , "clicked" .= getExtendedContactDetailsAllOfStatisticsClicked
      , "transacAttributes" .= getExtendedContactDetailsAllOfStatisticsTransacAttributes
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatistics' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatistics
  :: GetExtendedContactDetailsAllOfStatistics
mkGetExtendedContactDetailsAllOfStatistics =
  GetExtendedContactDetailsAllOfStatistics
  { getExtendedContactDetailsAllOfStatisticsMessagesSent = Nothing
  , getExtendedContactDetailsAllOfStatisticsHardBounces = Nothing
  , getExtendedContactDetailsAllOfStatisticsSoftBounces = Nothing
  , getExtendedContactDetailsAllOfStatisticsComplaints = Nothing
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptions = Nothing
  , getExtendedContactDetailsAllOfStatisticsOpened = Nothing
  , getExtendedContactDetailsAllOfStatisticsClicked = Nothing
  , getExtendedContactDetailsAllOfStatisticsTransacAttributes = Nothing
  }

-- ** GetExtendedContactDetailsAllOfStatisticsClicked
-- | GetExtendedContactDetailsAllOfStatisticsClicked
data GetExtendedContactDetailsAllOfStatisticsClicked = GetExtendedContactDetailsAllOfStatisticsClicked
  { getExtendedContactDetailsAllOfStatisticsClickedCampaignId :: !(Integer) -- ^ /Required/ "campaignId" - ID of the campaign which generated the event
  , getExtendedContactDetailsAllOfStatisticsClickedLinks :: !([GetExtendedContactDetailsAllOfStatisticsLinks]) -- ^ /Required/ "links" - Listing of the clicked links for the campaign
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatisticsClicked
instance A.FromJSON GetExtendedContactDetailsAllOfStatisticsClicked where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatisticsClicked" $ \o ->
    GetExtendedContactDetailsAllOfStatisticsClicked
      <$> (o .:  "campaignId")
      <*> (o .:  "links")

-- | ToJSON GetExtendedContactDetailsAllOfStatisticsClicked
instance A.ToJSON GetExtendedContactDetailsAllOfStatisticsClicked where
  toJSON GetExtendedContactDetailsAllOfStatisticsClicked {..} =
   _omitNulls
      [ "campaignId" .= getExtendedContactDetailsAllOfStatisticsClickedCampaignId
      , "links" .= getExtendedContactDetailsAllOfStatisticsClickedLinks
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatisticsClicked' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatisticsClicked
  :: Integer -- ^ 'getExtendedContactDetailsAllOfStatisticsClickedCampaignId': ID of the campaign which generated the event
  -> [GetExtendedContactDetailsAllOfStatisticsLinks] -- ^ 'getExtendedContactDetailsAllOfStatisticsClickedLinks': Listing of the clicked links for the campaign
  -> GetExtendedContactDetailsAllOfStatisticsClicked
mkGetExtendedContactDetailsAllOfStatisticsClicked getExtendedContactDetailsAllOfStatisticsClickedCampaignId getExtendedContactDetailsAllOfStatisticsClickedLinks =
  GetExtendedContactDetailsAllOfStatisticsClicked
  { getExtendedContactDetailsAllOfStatisticsClickedCampaignId
  , getExtendedContactDetailsAllOfStatisticsClickedLinks
  }

-- ** GetExtendedContactDetailsAllOfStatisticsLinks
-- | GetExtendedContactDetailsAllOfStatisticsLinks
data GetExtendedContactDetailsAllOfStatisticsLinks = GetExtendedContactDetailsAllOfStatisticsLinks
  { getExtendedContactDetailsAllOfStatisticsLinksCount :: !(Integer) -- ^ /Required/ "count" - Number of clicks on this link for the campaign
  , getExtendedContactDetailsAllOfStatisticsLinksEventTime :: !(DateTime) -- ^ /Required/ "eventTime" - UTC date-time of the event
  , getExtendedContactDetailsAllOfStatisticsLinksIp :: !(Text) -- ^ /Required/ "ip" - IP from which the user has clicked on the link
  , getExtendedContactDetailsAllOfStatisticsLinksUrl :: !(Text) -- ^ /Required/ "url" - URL of the clicked link
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatisticsLinks
instance A.FromJSON GetExtendedContactDetailsAllOfStatisticsLinks where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatisticsLinks" $ \o ->
    GetExtendedContactDetailsAllOfStatisticsLinks
      <$> (o .:  "count")
      <*> (o .:  "eventTime")
      <*> (o .:  "ip")
...
-- | ToJSON GetExtendedContactDetailsAllOfStatisticsLinks
instance A.ToJSON GetExtendedContactDetailsAllOfStatisticsLinks where
  toJSON GetExtendedContactDetailsAllOfStatisticsLinks {..} =
   _omitNulls
      [ "count" .= getExtendedContactDetailsAllOfStatisticsLinksCount
      , "eventTime" .= getExtendedContactDetailsAllOfStatisticsLinksEventTime
      , "ip" .= getExtendedContactDetailsAllOfStatisticsLinksIp
      , "url" .= getExtendedContactDetailsAllOfStatisticsLinksUrl
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatisticsLinks' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatisticsLinks
  :: Integer -- ^ 'getExtendedContactDetailsAllOfStatisticsLinksCount': Number of clicks on this link for the campaign
  -> DateTime -- ^ 'getExtendedContactDetailsAllOfStatisticsLinksEventTime': UTC date-time of the event
  -> Text -- ^ 'getExtendedContactDetailsAllOfStatisticsLinksIp': IP from which the user has clicked on the link
  -> Text -- ^ 'getExtendedContactDetailsAllOfStatisticsLinksUrl': URL of the clicked link
  -> GetExtendedContactDetailsAllOfStatisticsLinks
mkGetExtendedContactDetailsAllOfStatisticsLinks getExtendedContactDetailsAllOfStatisticsLinksCount getExtendedContactDetailsAllOfStatisticsLinksEventTime getExtendedContactDetailsAllOfStatisticsLinksIp getExtendedContactDetailsAllOfStatisticsLinksUrl =
  GetExtendedContactDetailsAllOfStatisticsLinks
  { getExtendedContactDetailsAllOfStatisticsLinksCount
  , getExtendedContactDetailsAllOfStatisticsLinksEventTime
  , getExtendedContactDetailsAllOfStatisticsLinksIp
  , getExtendedContactDetailsAllOfStatisticsLinksUrl
  }

-- ** GetExtendedContactDetailsAllOfStatisticsMessagesSent
-- | GetExtendedContactDetailsAllOfStatisticsMessagesSent
data GetExtendedContactDetailsAllOfStatisticsMessagesSent = GetExtendedContactDetailsAllOfStatisticsMessagesSent
  { getExtendedContactDetailsAllOfStatisticsMessagesSentCampaignId :: !(Integer) -- ^ /Required/ "campaignId" - ID of the campaign which generated the event
  , getExtendedContactDetailsAllOfStatisticsMessagesSentEventTime :: !(DateTime) -- ^ /Required/ "eventTime" - UTC date-time of the event
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatisticsMessagesSent
instance A.FromJSON GetExtendedContactDetailsAllOfStatisticsMessagesSent where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatisticsMessagesSent" $ \o ->
    GetExtendedContactDetailsAllOfStatisticsMessagesSent
      <$> (o .:  "campaignId")
      <*> (o .:  "eventTime")

-- | ToJSON GetExtendedContactDetailsAllOfStatisticsMessagesSent
instance A.ToJSON GetExtendedContactDetailsAllOfStatisticsMessagesSent where
  toJSON GetExtendedContactDetailsAllOfStatisticsMessagesSent {..} =
   _omitNulls
      [ "campaignId" .= getExtendedContactDetailsAllOfStatisticsMessagesSentCampaignId
      , "eventTime" .= getExtendedContactDetailsAllOfStatisticsMessagesSentEventTime
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatisticsMessagesSent' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatisticsMessagesSent
  :: Integer -- ^ 'getExtendedContactDetailsAllOfStatisticsMessagesSentCampaignId': ID of the campaign which generated the event
  -> DateTime -- ^ 'getExtendedContactDetailsAllOfStatisticsMessagesSentEventTime': UTC date-time of the event
  -> GetExtendedContactDetailsAllOfStatisticsMessagesSent
mkGetExtendedContactDetailsAllOfStatisticsMessagesSent getExtendedContactDetailsAllOfStatisticsMessagesSentCampaignId getExtendedContactDetailsAllOfStatisticsMessagesSentEventTime =
  GetExtendedContactDetailsAllOfStatisticsMessagesSent
  { getExtendedContactDetailsAllOfStatisticsMessagesSentCampaignId
  , getExtendedContactDetailsAllOfStatisticsMessagesSentEventTime
  }

-- ** GetExtendedContactDetailsAllOfStatisticsOpened
-- | GetExtendedContactDetailsAllOfStatisticsOpened
data GetExtendedContactDetailsAllOfStatisticsOpened = GetExtendedContactDetailsAllOfStatisticsOpened
  { getExtendedContactDetailsAllOfStatisticsOpenedCampaignId :: !(Integer) -- ^ /Required/ "campaignId" - ID of the campaign which generated the event
  , getExtendedContactDetailsAllOfStatisticsOpenedCount :: !(Integer) -- ^ /Required/ "count" - Number of openings for the campaign
  , getExtendedContactDetailsAllOfStatisticsOpenedEventTime :: !(DateTime) -- ^ /Required/ "eventTime" - UTC date-time of the event
  , getExtendedContactDetailsAllOfStatisticsOpenedIp :: !(Text) -- ^ /Required/ "ip" - IP from which the user has opened the email
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatisticsOpened
instance A.FromJSON GetExtendedContactDetailsAllOfStatisticsOpened where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatisticsOpened" $ \o ->
    GetExtendedContactDetailsAllOfStatisticsOpened
      <$> (o .:  "campaignId")
      <*> (o .:  "count")
      <*> (o .:  "eventTime")
...
-- | ToJSON GetExtendedContactDetailsAllOfStatisticsOpened
instance A.ToJSON GetExtendedContactDetailsAllOfStatisticsOpened where
  toJSON GetExtendedContactDetailsAllOfStatisticsOpened {..} =
   _omitNulls
      [ "campaignId" .= getExtendedContactDetailsAllOfStatisticsOpenedCampaignId
      , "count" .= getExtendedContactDetailsAllOfStatisticsOpenedCount
      , "eventTime" .= getExtendedContactDetailsAllOfStatisticsOpenedEventTime
      , "ip" .= getExtendedContactDetailsAllOfStatisticsOpenedIp
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatisticsOpened' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatisticsOpened
  :: Integer -- ^ 'getExtendedContactDetailsAllOfStatisticsOpenedCampaignId': ID of the campaign which generated the event
  -> Integer -- ^ 'getExtendedContactDetailsAllOfStatisticsOpenedCount': Number of openings for the campaign
  -> DateTime -- ^ 'getExtendedContactDetailsAllOfStatisticsOpenedEventTime': UTC date-time of the event
  -> Text -- ^ 'getExtendedContactDetailsAllOfStatisticsOpenedIp': IP from which the user has opened the email
  -> GetExtendedContactDetailsAllOfStatisticsOpened
mkGetExtendedContactDetailsAllOfStatisticsOpened getExtendedContactDetailsAllOfStatisticsOpenedCampaignId getExtendedContactDetailsAllOfStatisticsOpenedCount getExtendedContactDetailsAllOfStatisticsOpenedEventTime getExtendedContactDetailsAllOfStatisticsOpenedIp =
  GetExtendedContactDetailsAllOfStatisticsOpened
  { getExtendedContactDetailsAllOfStatisticsOpenedCampaignId
  , getExtendedContactDetailsAllOfStatisticsOpenedCount
  , getExtendedContactDetailsAllOfStatisticsOpenedEventTime
  , getExtendedContactDetailsAllOfStatisticsOpenedIp
  }

-- ** GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
-- | GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
-- Listing of the unsubscription for the contact
data GetExtendedContactDetailsAllOfStatisticsUnsubscriptions = GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
  { getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription :: !([GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription]) -- ^ /Required/ "userUnsubscription" - Contact unsubscribe via unsubscription link in a campaign
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription :: !([GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription]) -- ^ /Required/ "adminUnsubscription" - Contact has been unsubscribed from the administrator
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
instance A.FromJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptions where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatisticsUnsubscriptions" $ \o ->
    GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
      <$> (o .:  "userUnsubscription")
      <*> (o .:  "adminUnsubscription")

-- | ToJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
instance A.ToJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptions where
  toJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptions {..} =
   _omitNulls
      [ "userUnsubscription" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
      , "adminUnsubscription" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatisticsUnsubscriptions' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatisticsUnsubscriptions
  :: [GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription] -- ^ 'getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription': Contact unsubscribe via unsubscription link in a campaign
  -> [GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription] -- ^ 'getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription': Contact has been unsubscribed from the administrator
  -> GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
mkGetExtendedContactDetailsAllOfStatisticsUnsubscriptions getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription =
  GetExtendedContactDetailsAllOfStatisticsUnsubscriptions
...
-- ** GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
-- | GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
data GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription = GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
  { getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionEventTime :: !(DateTime) -- ^ /Required/ "eventTime" - UTC date-time of the event
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionIp :: !(Maybe Text) -- ^ "ip" - IP from which the user has been unsubscribed
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
instance A.FromJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription" $ \o ->
    GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
      <$> (o .:  "eventTime")
      <*> (o .:? "ip")

-- | ToJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
instance A.ToJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription where
  toJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription {..} =
   _omitNulls
      [ "eventTime" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionEventTime
      , "ip" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionIp
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
  :: DateTime -- ^ 'getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionEventTime': UTC date-time of the event
  -> GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
mkGetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionEventTime =
  GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscription
  { getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionEventTime
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptionsAdminUnsubscriptionIp = Nothing
  }

-- ** GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
-- | GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
data GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription = GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
  { getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionCampaignId :: !(Integer) -- ^ /Required/ "campaignId" - ID of the campaign which generated the event
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionEventTime :: !(DateTime) -- ^ /Required/ "eventTime" - UTC date-time of the event
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionIp :: !(Maybe Text) -- ^ "ip" - IP from which the user has unsubscribed
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
instance A.FromJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription where
  parseJSON = A.withObject "GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription" $ \o ->
    GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
      <$> (o .:  "campaignId")
      <*> (o .:  "eventTime")
      <*> (o .:? "ip")

-- | ToJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
instance A.ToJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription where
  toJSON GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription {..} =
   _omitNulls
      [ "campaignId" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionCampaignId
      , "eventTime" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionEventTime
      , "ip" .= getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionIp
      ]


-- | Construct a value of type 'GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription' (by applying it's required fields, if any)
mkGetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
  :: Integer -- ^ 'getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionCampaignId': ID of the campaign which generated the event
  -> DateTime -- ^ 'getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionEventTime': UTC date-time of the event
  -> GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
mkGetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionCampaignId getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionEventTime =
  GetExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscription
  { getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionCampaignId
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionEventTime
  , getExtendedContactDetailsAllOfStatisticsUnsubscriptionsUserUnsubscriptionIp = Nothing
  }
...
data GetExtendedList = GetExtendedList
  ...
  , getExtendedListCampaignStats :: !(Maybe [GetExtendedListAllOfCampaignStats]) -- ^ "campaignStats"
...
-- | GetExtendedListAllOf
data GetExtendedListAllOf = GetExtendedListAllOf
  { getExtendedListAllOfFolderId :: !(Integer) -- ^ /Required/ "folderId" - ID of the folder
  , getExtendedListAllOfCreatedAt :: !(DateTime) -- ^ /Required/ "createdAt" - Creation UTC date-time of the list (YYYY-MM-DDTHH:mm:ss.SSSZ)
  , getExtendedListAllOfCampaignStats :: !(Maybe [GetExtendedListAllOfCampaignStats]) -- ^ "campaignStats"
  , getExtendedListAllOfDynamicList :: !(Maybe Bool) -- ^ "dynamicList" - Status telling if the list is dynamic or not (true&#x3D;dynamic, false&#x3D;not dynamic)
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedListAllOf
instance A.FromJSON GetExtendedListAllOf where
  parseJSON = A.withObject "GetExtendedListAllOf" $ \o ->
    GetExtendedListAllOf
      <$> (o .:  "folderId")
      <*> (o .:  "createdAt")
      <*> (o .:? "campaignStats")
...
-- | ToJSON GetExtendedListAllOf
instance A.ToJSON GetExtendedListAllOf where
  toJSON GetExtendedListAllOf {..} =
   _omitNulls
      [ "folderId" .= getExtendedListAllOfFolderId
      , "createdAt" .= getExtendedListAllOfCreatedAt
      , "campaignStats" .= getExtendedListAllOfCampaignStats
      , "dynamicList" .= getExtendedListAllOfDynamicList
      ]


-- | Construct a value of type 'GetExtendedListAllOf' (by applying it's required fields, if any)
mkGetExtendedListAllOf
  :: Integer -- ^ 'getExtendedListAllOfFolderId': ID of the folder
  -> DateTime -- ^ 'getExtendedListAllOfCreatedAt': Creation UTC date-time of the list (YYYY-MM-DDTHH:mm:ss.SSSZ)
  -> GetExtendedListAllOf
mkGetExtendedListAllOf getExtendedListAllOfFolderId getExtendedListAllOfCreatedAt =
  GetExtendedListAllOf
  { getExtendedListAllOfFolderId
  , getExtendedListAllOfCreatedAt
  , getExtendedListAllOfCampaignStats = Nothing
  , getExtendedListAllOfDynamicList = Nothing
  }

-- ** GetExtendedListAllOfCampaignStats
-- | GetExtendedListAllOfCampaignStats
data GetExtendedListAllOfCampaignStats = GetExtendedListAllOfCampaignStats
  { getExtendedListAllOfCampaignStatsCampaignId :: !(Integer) -- ^ /Required/ "campaignId" - ID of the campaign
  , getExtendedListAllOfCampaignStatsStats :: !(GetCampaignStats) -- ^ /Required/ "stats"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetExtendedListAllOfCampaignStats
instance A.FromJSON GetExtendedListAllOfCampaignStats where
  parseJSON = A.withObject "GetExtendedListAllOfCampaignStats" $ \o ->
    GetExtendedListAllOfCampaignStats
      <$> (o .:  "campaignId")
      <*> (o .:  "stats")

-- | ToJSON GetExtendedListAllOfCampaignStats
instance A.ToJSON GetExtendedListAllOfCampaignStats where
  toJSON GetExtendedListAllOfCampaignStats {..} =
   _omitNulls
      [ "campaignId" .= getExtendedListAllOfCampaignStatsCampaignId
      , "stats" .= getExtendedListAllOfCampaignStatsStats
      ]


-- | Construct a value of type 'GetExtendedListAllOfCampaignStats' (by applying it's required fields, if any)
mkGetExtendedListAllOfCampaignStats
  :: Integer -- ^ 'getExtendedListAllOfCampaignStatsCampaignId': ID of the campaign
  -> GetCampaignStats -- ^ 'getExtendedListAllOfCampaignStatsStats' 
  -> GetExtendedListAllOfCampaignStats
mkGetExtendedListAllOfCampaignStats getExtendedListAllOfCampaignStatsCampaignId getExtendedListAllOfCampaignStatsStats =
  GetExtendedListAllOfCampaignStats
  { getExtendedListAllOfCampaignStatsCampaignId
  , getExtendedListAllOfCampaignStatsStats
  }
...
data GetFolderLists = GetFolderLists
  { getFolderListsLists :: !([GetList]) -- ^ /Required/ "lists"
...
data GetFolders = GetFolders
  { getFoldersFolders :: !(Maybe [GetFolder]) -- ^ "folders"
...
data GetLists = GetLists
  { getListsLists :: !([GetList]) -- ^ /Required/ "lists" - Listing of all the lists available in your account
...
mkGetLists
  :: [GetList] -- ^ 'getListsLists': Listing of all the lists available in your account
...
data GetSmsCampaign = GetSmsCampaign
  ...
  , getSmsCampaignRecipients :: !(GetCampaignRecipients) -- ^ /Required/ "recipients"
  , getSmsCampaignStatistics :: !(GetSmsCampaignStats) -- ^ /Required/ "statistics"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetSmsCampaign
  ...
  -> GetCampaignRecipients -- ^ 'getSmsCampaignRecipients' 
  -> GetSmsCampaignStats -- ^ 'getSmsCampaignStatistics' 
  -> GetSmsCampaign
...
-- ** GetSmsCampaignAllOf
-- | GetSmsCampaignAllOf
data GetSmsCampaignAllOf = GetSmsCampaignAllOf
  { getSmsCampaignAllOfRecipients :: !(GetCampaignRecipients) -- ^ /Required/ "recipients"
  , getSmsCampaignAllOfStatistics :: !(GetSmsCampaignStats) -- ^ /Required/ "statistics"
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON GetSmsCampaignAllOf
instance A.FromJSON GetSmsCampaignAllOf where
  parseJSON = A.withObject "GetSmsCampaignAllOf" $ \o ->
    GetSmsCampaignAllOf
      <$> (o .:  "recipients")
      <*> (o .:  "statistics")

-- | ToJSON GetSmsCampaignAllOf
instance A.ToJSON GetSmsCampaignAllOf where
  toJSON GetSmsCampaignAllOf {..} =
   _omitNulls
      [ "recipients" .= getSmsCampaignAllOfRecipients
      , "statistics" .= getSmsCampaignAllOfStatistics
      ]


-- | Construct a value of type 'GetSmsCampaignAllOf' (by applying it's required fields, if any)
mkGetSmsCampaignAllOf
  :: GetCampaignRecipients -- ^ 'getSmsCampaignAllOfRecipients' 
  -> GetSmsCampaignStats -- ^ 'getSmsCampaignAllOfStatistics' 
  -> GetSmsCampaignAllOf
mkGetSmsCampaignAllOf getSmsCampaignAllOfRecipients getSmsCampaignAllOfStatistics =
  GetSmsCampaignAllOf
  { getSmsCampaignAllOfRecipients
  , getSmsCampaignAllOfStatistics
  }
...
data GetSmsCampaigns = GetSmsCampaigns
  { getSmsCampaignsCampaigns :: !(Maybe [GetSmsCampaignOverview]) -- ^ "campaigns"
...
data GetSmtpTemplateOverview = GetSmtpTemplateOverview
  ...
  , getSmtpTemplateOverviewDoiTemplate :: !(Maybe Bool) -- ^ "doiTemplate" - It is true if template is a valid Double opt-in (DOI) template, otherwise it is false. This field will be available only in case of single template detail call.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON GetSmtpTemplateOverview where
  toJSON GetSmtpTemplateOverview {..} =
   _omitNulls
      ...
      , "doiTemplate" .= getSmtpTemplateOverviewDoiTemplate
      ]
...
mkGetSmtpTemplateOverview getSmtpTemplateOverviewId getSmtpTemplateOverviewName getSmtpTemplateOverviewSubject getSmtpTemplateOverviewIsActive getSmtpTemplateOverviewTestSent getSmtpTemplateOverviewSender getSmtpTemplateOverviewReplyTo getSmtpTemplateOverviewToField getSmtpTemplateOverviewTag getSmtpTemplateOverviewHtmlContent getSmtpTemplateOverviewCreatedAt getSmtpTemplateOverviewModifiedAt =
  ...
  , getSmtpTemplateOverviewDoiTemplate = Nothing
  }
...
data GetTransacBlockedContactsContacts = GetTransacBlockedContactsContacts
  ...
  , getTransacBlockedContactsContactsBlockedAt :: !(DateTime) -- ^ /Required/ "blockedAt" - Date when the contact was blocked or unsubscribed on
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetTransacBlockedContactsContacts
  ...
  -> DateTime -- ^ 'getTransacBlockedContactsContactsBlockedAt': Date when the contact was blocked or unsubscribed on
  -> GetTransacBlockedContactsContacts
...
data GetTransacEmailsListTransactionalEmails = GetTransacEmailsListTransactionalEmails
  ...
  , getTransacEmailsListTransactionalEmailsFrom :: !(Maybe Text) -- ^ "from" - Email address of the sender from which the email was sent
  , getTransacEmailsListTransactionalEmailsTags :: !(Maybe [Text]) -- ^ "tags" - Tags used for your email
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON GetTransacEmailsListTransactionalEmails where
  toJSON GetTransacEmailsListTransactionalEmails {..} =
   _omitNulls
      ...
      , "from" .= getTransacEmailsListTransactionalEmailsFrom
      , "tags" .= getTransacEmailsListTransactionalEmailsTags
      ]
...
mkGetTransacEmailsListTransactionalEmails getTransacEmailsListTransactionalEmailsEmail getTransacEmailsListTransactionalEmailsSubject getTransacEmailsListTransactionalEmailsMessageId getTransacEmailsListTransactionalEmailsUuid getTransacEmailsListTransactionalEmailsDate =
  ...
  , getTransacEmailsListTransactionalEmailsFrom = Nothing
  , getTransacEmailsListTransactionalEmailsTags = Nothing
  }
...
data GetWebhooks = GetWebhooks
  { getWebhooksWebhooks :: !([GetWebhook]) -- ^ /Required/ "webhooks"
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkGetWebhooks
  :: [GetWebhook] -- ^ 'getWebhooksWebhooks' 
  -> GetWebhooks
...
data PostContactInfoContacts = PostContactInfoContacts
  ...
  , postContactInfoContactsProcessId :: !(Maybe Integer) -- ^ "processId" - Id of the process created to remove contacts from list when user opts for \&quot;all\&quot; option.
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON PostContactInfoContacts where
  toJSON PostContactInfoContacts {..} =
   _omitNulls
      ...
      , "processId" .= postContactInfoContactsProcessId
      ]
...
mkPostContactInfoContacts =
  ...
  , postContactInfoContactsProcessId = Nothing
  }
...
data RemainingCreditModelChild = RemainingCreditModelChild
  { remainingCreditModelChildSms :: !(Double) -- ^ /Required/ "sms" - SMS Credits remaining for child account
  , remainingCreditModelChildEmail :: !(Double) -- ^ /Required/ "email" - Email Credits remaining for child account
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkRemainingCreditModelChild
  :: Double -- ^ 'remainingCreditModelChildSms': SMS Credits remaining for child account
  -> Double -- ^ 'remainingCreditModelChildEmail': Email Credits remaining for child account
  -> RemainingCreditModelChild
...
data RemainingCreditModelReseller = RemainingCreditModelReseller
  { remainingCreditModelResellerSms :: !(Double) -- ^ /Required/ "sms" - SMS Credits remaining for reseller account
  , remainingCreditModelResellerEmail :: !(Double) -- ^ /Required/ "email" - Email Credits remaining for reseller account
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkRemainingCreditModelReseller
  :: Double -- ^ 'remainingCreditModelResellerSms': SMS Credits remaining for reseller account
  -> Double -- ^ 'remainingCreditModelResellerEmail': Email Credits remaining for reseller account
  -> RemainingCreditModelReseller
...
data RemoveContactFromList = RemoveContactFromList
  { removeContactFromListEmails :: !(Maybe [Text]) -- ^ "emails" - Required if &#39;all&#39; is false. Emails to remove from a list. You can pass a maximum of 150 emails for removal in one request.
  , removeContactFromListAll :: !(Maybe Bool) -- ^ "all" - Required if &#39;emails&#39; is empty. Remove all existing contacts from a list. A process will be created in this scenario. You can fetch the process details to know about the progress
  } deriving (P.Show, P.Eq, P.Typeable)
...
data RequestContactExport = RequestContactExport
  ...
  , requestContactExportContactFilter :: !(Maybe A.Value) -- ^ "contactFilter" - This attribute has been deprecated and will be removed by January 1st, 2021. Only one of the two filter options (contactFilter or customContactFilter) can be passed in the request. Set the filter for the contacts to be exported. For example, {\&quot;blacklisted\&quot;:true} will export all the blacklisted contacts. 
  , requestContactExportCustomContactFilter :: !(Maybe RequestContactExportCustomContactFilter) -- ^ "customContactFilter"
  , requestContactExportNotifyUrl :: !(Maybe Text) -- ^ "notifyUrl" - Webhook that will be called once the export process is finished. For reference, https://help.sendinblue.com/hc/en-us/articles/360007666479
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkRequestContactExport =
  ...
  , requestContactExportContactFilter = Nothing
  , requestContactExportCustomContactFilter = Nothing
...
data RequestContactExportCustomContactFilter = RequestContactExportCustomContactFilter
  { requestContactExportCustomContactFilterActionForContacts :: !(Maybe E'ActionForContacts) -- ^ "actionForContacts" - Mandatory if neither actionForEmailCampaigns nor actionForSmsCampaigns is passed. This will export the contacts on the basis of provided action applied on contacts as per the list id. * allContacts - Fetch the list of all contacts for a particular list. * subscribed &amp; unsubscribed - Fetch the list of subscribed / unsubscribed (blacklisted via any means) contacts for a particular list. * unsubscribedPerList - Fetch the list of contacts that are unsubscribed from a particular list only. 
  , requestContactExportCustomContactFilterActionForEmailCampaigns :: !(Maybe E'ActionForEmailCampaigns) -- ^ "actionForEmailCampaigns" - Mandatory if neither actionForContacts nor actionForSmsCampaigns is passed. This will export the contacts on the basis of provided action applied on email campaigns. * openers &amp; nonOpeners - emailCampaignId is mandatory. Fetch the list of readers / non-readers for a particular email campaign. * clickers &amp; nonClickers - emailCampaignId is mandatory. Fetch the list of clickers / non-clickers for a particular email campaign. * unsubscribed - emailCampaignId is mandatory. Fetch the list of all unsubscribed (blacklisted via any means) contacts for a particular email campaign. * hardBounces &amp; softBounces - emailCampaignId is optional. Fetch the list of hard bounces / soft bounces for a particular / all email campaign(s). 
  , requestContactExportCustomContactFilterActionForSmsCampaigns :: !(Maybe E'ActionForSmsCampaigns) -- ^ "actionForSmsCampaigns" - Mandatory if neither actionForContacts nor actionForEmailCampaigns is passed. This will export the contacts on the basis of provided action applied on sms campaigns. * unsubscribed - Fetch the list of all unsubscribed (blacklisted via any means) contacts for all / particular sms campaigns. * hardBounces &amp; softBounces - Fetch the list of hard bounces / soft bounces for all / particular sms campaigns. 
  , requestContactExportCustomContactFilterListId :: !(Maybe Integer) -- ^ "listId" - Mandatory if actionForContacts is passed, ignored otherwise. Id of the list for which the corresponding action shall be applied in the filter.
  , requestContactExportCustomContactFilterEmailCampaignId :: !(Maybe Integer) -- ^ "emailCampaignId" - Considered only if actionForEmailCampaigns is passed, ignored otherwise. Mandatory if action is one of the following - openers, nonOpeners, clickers, nonClickers, unsubscribed. The id of the email campaign for which the corresponding action shall be applied in the filter.
  , requestContactExportCustomContactFilterSmsCampaignId :: !(Maybe Integer) -- ^ "smsCampaignId" - Considered only if actionForSmsCampaigns is passed, ignored otherwise. The id of sms campaign for which the corresponding action shall be applied in the filter.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON RequestContactExportCustomContactFilter
instance A.FromJSON RequestContactExportCustomContactFilter where
  parseJSON = A.withObject "RequestContactExportCustomContactFilter" $ \o ->
    RequestContactExportCustomContactFilter
      <$> (o .:? "actionForContacts")
      <*> (o .:? "actionForEmailCampaigns")
      <*> (o .:? "actionForSmsCampaigns")
      <*> (o .:? "listId")
      <*> (o .:? "emailCampaignId")
      <*> (o .:? "smsCampaignId")

-- | ToJSON RequestContactExportCustomContactFilter
instance A.ToJSON RequestContactExportCustomContactFilter where
  toJSON RequestContactExportCustomContactFilter {..} =
   _omitNulls
      ...
      , "listId" .= requestContactExportCustomContactFilterListId
      , "emailCampaignId" .= requestContactExportCustomContactFilterEmailCampaignId
      , "smsCampaignId" .= requestContactExportCustomContactFilterSmsCampaignId
      ]


-- | Construct a value of type 'RequestContactExportCustomContactFilter' (by applying it's required fields, if any)
mkRequestContactExportCustomContactFilter
  :: RequestContactExportCustomContactFilter
mkRequestContactExportCustomContactFilter =
  RequestContactExportCustomContactFilter
  { requestContactExportCustomContactFilterActionForContacts = Nothing
  , requestContactExportCustomContactFilterActionForEmailCampaigns = Nothing
  , requestContactExportCustomContactFilterActionForSmsCampaigns = Nothing
  , requestContactExportCustomContactFilterListId = Nothing
  , requestContactExportCustomContactFilterEmailCampaignId = Nothing
  , requestContactExportCustomContactFilterSmsCampaignId = Nothing
  }
...
data RequestContactImport = RequestContactImport
  ...
  , requestContactImportFileBody :: !(Maybe Text) -- ^ "fileBody" - Mandatory if fileUrl is not defined. CSV content to be imported. Use semicolon to separate multiple attributes. Maximum allowed file body size is 10MB . However we recommend a safe limit of around 8 MB to avoid the issues caused due to increase of file body size while parsing. Please use fileUrl instead to import bigger files.
  ...
  , requestContactImportNotifyUrl :: !(Maybe Text) -- ^ "notifyUrl" - URL that will be called once the import process is finished. For reference, https://help.sendinblue.com/hc/en-us/articles/360007666479
...
data RequestSmsRecipientExport = RequestSmsRecipientExport
  { requestSmsRecipientExportNotifyUrl :: !(Maybe Text) -- ^ "notifyURL" - URL that will be called once the export process is finished. For reference, https://help.sendinblue.com/hc/en-us/articles/360007666479
...
data SendReportEmail = SendReportEmail
  ...
  , sendReportEmailBody :: !(Text) -- ^ /Required/ "body" - Custom text message to be presented in the report email.
  } deriving (P.Show, P.Eq, P.Typeable)
...
mkSendReportEmail
  ...
  -> Text -- ^ 'sendReportEmailBody': Custom text message to be presented in the report email.
  -> SendReportEmail
mkSendReportEmail sendReportEmailTo sendReportEmailBody =
  SendReportEmail
  { sendReportEmailTo
  , sendReportEmailBody
  }
...
data SendTransacSms = SendTransacSms
  { sendTransacSmsSender :: !(Text) -- ^ /Required/ "sender" - Name of the sender. **The number of characters is limited to 11 for alphanumeric characters and 15 for numeric characters**
...
mkSendTransacSms
  :: Text -- ^ 'sendTransacSmsSender': Name of the sender. **The number of characters is limited to 11 for alphanumeric characters and 15 for numeric characters**
...
data UpdateChildAccountStatus = UpdateChildAccountStatus
  ...
  , updateChildAccountStatusSmsCampaign :: !(Maybe Bool) -- ^ "smsCampaign" - Status of SMS Campaign Platform activation for your account (true&#x3D;enabled, false&#x3D;disabled)
  } deriving (P.Show, P.Eq, P.Typeable)
...
instance A.ToJSON UpdateChildAccountStatus where
  toJSON UpdateChildAccountStatus {..} =
   _omitNulls
      ...
      , "smsCampaign" .= updateChildAccountStatusSmsCampaign
      ]
...
mkUpdateChildAccountStatus =
  ...
  , updateChildAccountStatusSmsCampaign = Nothing
  }
...
data UpdateSmsCampaign = UpdateSmsCampaign
  ...
  , updateSmsCampaignSender :: !(Maybe Text) -- ^ "sender" - Name of the sender. **The number of characters is limited to 11 for alphanumeric characters and 15 for numeric characters**
...
data UpdateWebhook = UpdateWebhook
  ...
  , updateWebhookEvents :: !(Maybe [E'Events2]) -- ^ "events" - Events triggering the webhook. Possible values for Transactional type webhook – &#x60;sent&#x60; OR &#x60;request&#x60;, &#x60;delivered&#x60;, &#x60;hardBounce&#x60;, &#x60;softBounce&#x60;, &#x60;blocked&#x60;, &#x60;spam&#x60;, &#x60;invalid&#x60;, &#x60;deferred&#x60;, &#x60;click&#x60;, &#x60;opened&#x60;, &#x60;uniqueOpened&#x60; and &#x60;unsubscribed&#x60; and possible values for Marketing type webhook – &#x60;spam&#x60;, &#x60;opened&#x60;, &#x60;click&#x60;, &#x60;hardBounce&#x60;, &#x60;softBounce&#x60;, &#x60;unsubscribed&#x60;, &#x60;listAddition&#x60; and &#x60;delivered&#x60;
  } deriving (P.Show, P.Eq, P.Typeable)
...
-- | UploadImageToGallery
data UploadImageToGallery = UploadImageToGallery
  { uploadImageToGalleryImageUrl :: !(Text) -- ^ /Required/ "imageUrl" - The absolute url of the image (no local file). Maximum allowed size for image is 2MB. Allowed extensions for images are - jpeg, jpg, png, bmp, gif.
  , uploadImageToGalleryName :: !(Maybe Text) -- ^ "name" - Name of the image.
  } deriving (P.Show, P.Eq, P.Typeable)

-- | FromJSON UploadImageToGallery
instance A.FromJSON UploadImageToGallery where
  parseJSON = A.withObject "UploadImageToGallery" $ \o ->
    UploadImageToGallery
      <$> (o .:  "imageUrl")
      <*> (o .:? "name")

-- | ToJSON UploadImageToGallery
instance A.ToJSON UploadImageToGallery where
  toJSON UploadImageToGallery {..} =
   _omitNulls
      [ "imageUrl" .= uploadImageToGalleryImageUrl
      , "name" .= uploadImageToGalleryName
      ]


-- | Construct a value of type 'UploadImageToGallery' (by applying it's required fields, if any)
mkUploadImageToGallery
  :: Text -- ^ 'uploadImageToGalleryImageUrl': The absolute url of the image (no local file). Maximum allowed size for image is 2MB. Allowed extensions for images are - jpeg, jpg, png, bmp, gif.
  -> UploadImageToGallery
mkUploadImageToGallery uploadImageToGalleryImageUrl =
  UploadImageToGallery
  { uploadImageToGalleryImageUrl
  , uploadImageToGalleryName = Nothing
  }
...
data E'ActionForContacts
  = E'ActionForContacts'AllContacts -- ^ @"allContacts"@
  | E'ActionForContacts'Subscribed -- ^ @"subscribed"@
  | E'ActionForContacts'Unsubscribed -- ^ @"unsubscribed"@
  | E'ActionForContacts'UnsubscribedPerList -- ^ @"unsubscribedPerList"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'ActionForContacts where toJSON = A.toJSON . fromE'ActionForContacts
instance A.FromJSON E'ActionForContacts where parseJSON o = P.either P.fail (pure . P.id) . toE'ActionForContacts =<< A.parseJSON o
instance WH.ToHttpApiData E'ActionForContacts where toQueryParam = WH.toQueryParam . fromE'ActionForContacts
instance WH.FromHttpApiData E'ActionForContacts where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'ActionForContacts
instance MimeRender MimeMultipartFormData E'ActionForContacts where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'ActionForContacts' enum
fromE'ActionForContacts :: E'ActionForContacts -> Text
fromE'ActionForContacts = \case
  E'ActionForContacts'AllContacts -> "allContacts"
  E'ActionForContacts'Subscribed -> "subscribed"
  E'ActionForContacts'Unsubscribed -> "unsubscribed"
  E'ActionForContacts'UnsubscribedPerList -> "unsubscribedPerList"

-- | parse 'E'ActionForContacts' enum
toE'ActionForContacts :: Text -> P.Either String E'ActionForContacts
toE'ActionForContacts = \case
  "allContacts" -> P.Right E'ActionForContacts'AllContacts
  "subscribed" -> P.Right E'ActionForContacts'Subscribed
  "unsubscribed" -> P.Right E'ActionForContacts'Unsubscribed
  "unsubscribedPerList" -> P.Right E'ActionForContacts'UnsubscribedPerList
  s -> P.Left $ "toE'ActionForContacts: enum parse failure: " P.++ P.show s


-- ** E'ActionForEmailCampaigns

-- | Enum of 'Text' .
-- Mandatory if neither actionForContacts nor actionForSmsCampaigns is passed. This will export the contacts on the basis of provided action applied on email campaigns. * openers & nonOpeners - emailCampaignId is mandatory. Fetch the list of readers / non-readers for a particular email campaign. * clickers & nonClickers - emailCampaignId is mandatory. Fetch the list of clickers / non-clickers for a particular email campaign. * unsubscribed - emailCampaignId is mandatory. Fetch the list of all unsubscribed (blacklisted via any means) contacts for a particular email campaign. * hardBounces & softBounces - emailCampaignId is optional. Fetch the list of hard bounces / soft bounces for a particular / all email campaign(s). 
data E'ActionForEmailCampaigns
  = E'ActionForEmailCampaigns'Openers -- ^ @"openers"@
  | E'ActionForEmailCampaigns'NonOpeners -- ^ @"nonOpeners"@
  | E'ActionForEmailCampaigns'Clickers -- ^ @"clickers"@
  | E'ActionForEmailCampaigns'NonClickers -- ^ @"nonClickers"@
  | E'ActionForEmailCampaigns'Unsubscribed -- ^ @"unsubscribed"@
  | E'ActionForEmailCampaigns'HardBounces -- ^ @"hardBounces"@
  | E'ActionForEmailCampaigns'SoftBounces -- ^ @"softBounces"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'ActionForEmailCampaigns where toJSON = A.toJSON . fromE'ActionForEmailCampaigns
instance A.FromJSON E'ActionForEmailCampaigns where parseJSON o = P.either P.fail (pure . P.id) . toE'ActionForEmailCampaigns =<< A.parseJSON o
instance WH.ToHttpApiData E'ActionForEmailCampaigns where toQueryParam = WH.toQueryParam . fromE'ActionForEmailCampaigns
instance WH.FromHttpApiData E'ActionForEmailCampaigns where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'ActionForEmailCampaigns
instance MimeRender MimeMultipartFormData E'ActionForEmailCampaigns where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'ActionForEmailCampaigns' enum
fromE'ActionForEmailCampaigns :: E'ActionForEmailCampaigns -> Text
fromE'ActionForEmailCampaigns = \case
  E'ActionForEmailCampaigns'Openers -> "openers"
  E'ActionForEmailCampaigns'NonOpeners -> "nonOpeners"
  E'ActionForEmailCampaigns'Clickers -> "clickers"
  E'ActionForEmailCampaigns'NonClickers -> "nonClickers"
...
-- | parse 'E'ActionForEmailCampaigns' enum
toE'ActionForEmailCampaigns :: Text -> P.Either String E'ActionForEmailCampaigns
toE'ActionForEmailCampaigns = \case
  "openers" -> P.Right E'ActionForEmailCampaigns'Openers
  "nonOpeners" -> P.Right E'ActionForEmailCampaigns'NonOpeners
  "clickers" -> P.Right E'ActionForEmailCampaigns'Clickers
  "nonClickers" -> P.Right E'ActionForEmailCampaigns'NonClickers
  "unsubscribed" -> P.Right E'ActionForEmailCampaigns'Unsubscribed
  "hardBounces" -> P.Right E'ActionForEmailCampaigns'HardBounces
  "softBounces" -> P.Right E'ActionForEmailCampaigns'SoftBounces
  s -> P.Left $ "toE'ActionForEmailCampaigns: enum parse failure: " P.++ P.show s


-- ** E'ActionForSmsCampaigns

-- | Enum of 'Text' .
-- Mandatory if neither actionForContacts nor actionForEmailCampaigns is passed. This will export the contacts on the basis of provided action applied on sms campaigns. * unsubscribed - Fetch the list of all unsubscribed (blacklisted via any means) contacts for all / particular sms campaigns. * hardBounces & softBounces - Fetch the list of hard bounces / soft bounces for all / particular sms campaigns. 
data E'ActionForSmsCampaigns
  = E'ActionForSmsCampaigns'HardBounces -- ^ @"hardBounces"@
  | E'ActionForSmsCampaigns'SoftBounces -- ^ @"softBounces"@
  | E'ActionForSmsCampaigns'Unsubscribed -- ^ @"unsubscribed"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'ActionForSmsCampaigns where toJSON = A.toJSON . fromE'ActionForSmsCampaigns
instance A.FromJSON E'ActionForSmsCampaigns where parseJSON o = P.either P.fail (pure . P.id) . toE'ActionForSmsCampaigns =<< A.parseJSON o
instance WH.ToHttpApiData E'ActionForSmsCampaigns where toQueryParam = WH.toQueryParam . fromE'ActionForSmsCampaigns
instance WH.FromHttpApiData E'ActionForSmsCampaigns where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'ActionForSmsCampaigns
instance MimeRender MimeMultipartFormData E'ActionForSmsCampaigns where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'ActionForSmsCampaigns' enum
fromE'ActionForSmsCampaigns :: E'ActionForSmsCampaigns -> Text
fromE'ActionForSmsCampaigns = \case
  E'ActionForSmsCampaigns'HardBounces -> "hardBounces"
  E'ActionForSmsCampaigns'SoftBounces -> "softBounces"
  E'ActionForSmsCampaigns'Unsubscribed -> "unsubscribed"

-- | parse 'E'ActionForSmsCampaigns' enum
toE'ActionForSmsCampaigns :: Text -> P.Either String E'ActionForSmsCampaigns
toE'ActionForSmsCampaigns = \case
  "hardBounces" -> P.Right E'ActionForSmsCampaigns'HardBounces
  "softBounces" -> P.Right E'ActionForSmsCampaigns'SoftBounces
  "unsubscribed" -> P.Right E'ActionForSmsCampaigns'Unsubscribed
  s -> P.Left $ "toE'ActionForSmsCampaigns: enum parse failure: " P.++ P.show s
...
-- | Enum of 'Text'
data E'Events2
  = E'Events2'HardBounce -- ^ @"hardBounce"@
  | E'Events2'SoftBounce -- ^ @"softBounce"@
  | E'Events2'Blocked -- ^ @"blocked"@
  | E'Events2'Spam -- ^ @"spam"@
  | E'Events2'Delivered -- ^ @"delivered"@
  | E'Events2'Request -- ^ @"request"@
  | E'Events2'Click -- ^ @"click"@
  | E'Events2'Invalid -- ^ @"invalid"@
  | E'Events2'Deferred -- ^ @"deferred"@
  | E'Events2'Opened -- ^ @"opened"@
  | E'Events2'UniqueOpened -- ^ @"uniqueOpened"@
  | E'Events2'Unsubscribed -- ^ @"unsubscribed"@
  | E'Events2'ListAddition -- ^ @"listAddition"@
  | E'Events2'ContactUpdated -- ^ @"contactUpdated"@
  | E'Events2'ContactDeleted -- ^ @"contactDeleted"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'Events2 where toJSON = A.toJSON . fromE'Events2
instance A.FromJSON E'Events2 where parseJSON o = P.either P.fail (pure . P.id) . toE'Events2 =<< A.parseJSON o
instance WH.ToHttpApiData E'Events2 where toQueryParam = WH.toQueryParam . fromE'Events2
instance WH.FromHttpApiData E'Events2 where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'Events2
instance MimeRender MimeMultipartFormData E'Events2 where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'Events2' enum
fromE'Events2 :: E'Events2 -> Text
fromE'Events2 = \case
  E'Events2'HardBounce -> "hardBounce"
  E'Events2'SoftBounce -> "softBounce"
  E'Events2'Blocked -> "blocked"
...
-- | parse 'E'Events2' enum
toE'Events2 :: Text -> P.Either String E'Events2
toE'Events2 = \case
  "hardBounce" -> P.Right E'Events2'HardBounce
  "softBounce" -> P.Right E'Events2'SoftBounce
  "blocked" -> P.Right E'Events2'Blocked
  "spam" -> P.Right E'Events2'Spam
  "delivered" -> P.Right E'Events2'Delivered
  "request" -> P.Right E'Events2'Request
  "click" -> P.Right E'Events2'Click
  "invalid" -> P.Right E'Events2'Invalid
  "deferred" -> P.Right E'Events2'Deferred
  "opened" -> P.Right E'Events2'Opened
  "uniqueOpened" -> P.Right E'Events2'UniqueOpened
  "unsubscribed" -> P.Right E'Events2'Unsubscribed
  "listAddition" -> P.Right E'Events2'ListAddition
  "contactUpdated" -> P.Right E'Events2'ContactUpdated
  "contactDeleted" -> P.Right E'Events2'ContactDeleted
  s -> P.Left $ "toE'Events2: enum parse failure: " P.++ P.show s
...
toE'Sort = \case
  "asc" -> P.Right E'Sort'Asc
  "desc" -> P.Right E'Sort'Desc
...
data E'WinningCriteria
  = E'WinningCriteria'Open -- ^ @"Open"@
  | E'WinningCriteria'Click -- ^ @"Click"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'WinningCriteria where toJSON = A.toJSON . fromE'WinningCriteria
instance A.FromJSON E'WinningCriteria where parseJSON o = P.either P.fail (pure . P.id) . toE'WinningCriteria =<< A.parseJSON o
instance WH.ToHttpApiData E'WinningCriteria where toQueryParam = WH.toQueryParam . fromE'WinningCriteria
instance WH.FromHttpApiData E'WinningCriteria where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'WinningCriteria
instance MimeRender MimeMultipartFormData E'WinningCriteria where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'WinningCriteria' enum
fromE'WinningCriteria :: E'WinningCriteria -> Text
fromE'WinningCriteria = \case
  E'WinningCriteria'Open -> "Open"
  E'WinningCriteria'Click -> "Click"

-- | parse 'E'WinningCriteria' enum
toE'WinningCriteria :: Text -> P.Either String E'WinningCriteria
toE'WinningCriteria = \case
  "Open" -> P.Right E'WinningCriteria'Open
  "Click" -> P.Right E'WinningCriteria'Click
  s -> P.Left $ "toE'WinningCriteria: enum parse failure: " P.++ P.show s
...
data E'WinningVersion
  = E'WinningVersion'NotAvailable -- ^ @"notAvailable"@
  | E'WinningVersion'Pending -- ^ @"pending"@
  | E'WinningVersion'Tie -- ^ @"tie"@
  | E'WinningVersion'A -- ^ @"A"@
  | E'WinningVersion'B -- ^ @"B"@
  deriving (P.Show, P.Eq, P.Typeable, P.Ord, P.Bounded, P.Enum)

instance A.ToJSON E'WinningVersion where toJSON = A.toJSON . fromE'WinningVersion
instance A.FromJSON E'WinningVersion where parseJSON o = P.either P.fail (pure . P.id) . toE'WinningVersion =<< A.parseJSON o
instance WH.ToHttpApiData E'WinningVersion where toQueryParam = WH.toQueryParam . fromE'WinningVersion
instance WH.FromHttpApiData E'WinningVersion where parseQueryParam o = WH.parseQueryParam o >>= P.left T.pack . toE'WinningVersion
instance MimeRender MimeMultipartFormData E'WinningVersion where mimeRender _ = mimeRenderDefaultMultipartFormData

-- | unwrap 'E'WinningVersion' enum
fromE'WinningVersion :: E'WinningVersion -> Text
fromE'WinningVersion = \case
  E'WinningVersion'NotAvailable -> "notAvailable"
  E'WinningVersion'Pending -> "pending"
  E'WinningVersion'Tie -> "tie"
  E'WinningVersion'A -> "A"
...
-- | parse 'E'WinningVersion' enum
toE'WinningVersion :: Text -> P.Either String E'WinningVersion
toE'WinningVersion = \case
  "notAvailable" -> P.Right E'WinningVersion'NotAvailable
  "pending" -> P.Right E'WinningVersion'Pending
  "tie" -> P.Right E'WinningVersion'Tie
  "A" -> P.Right E'WinningVersion'A
  "B" -> P.Right E'WinningVersion'B
  s -> P.Left $ "toE'WinningVersion: enum parse failure: " P.++ P.show s
