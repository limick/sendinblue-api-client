...
module SendinBlue.Core where

import SendinBlue.MimeTypes
import SendinBlue.Logging
...
-- | 
data SendinBlueConfig = SendinBlueConfig
...
-- | display the config
instance P.Show SendinBlueConfig where
  show c =
    T.printf
...
-- | constructs a default SendinBlueConfig
--
-- configHost:
--
...
addAuthMethod :: AuthMethod auth => SendinBlueConfig -> auth -> SendinBlueConfig
addAuthMethod config@SendinBlueConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: SendinBlueConfig -> IO SendinBlueConfig
...
withStderrLogging :: SendinBlueConfig -> IO SendinBlueConfig
...
withNoLogging :: SendinBlueConfig -> SendinBlueConfig
...
data SendinBlueRequest req contentType res accept = SendinBlueRequest
  { rMethod  :: NH.Method   -- ^ Method of SendinBlueRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of SendinBlueRequest
  , rParams   :: Params -- ^ params of SendinBlueRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (SendinBlueRequest req contentType res accept) NH.Method
rMethodL f SendinBlueRequest{..} = (\rMethod -> SendinBlueRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (SendinBlueRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f SendinBlueRequest{..} = (\rUrlPath -> SendinBlueRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (SendinBlueRequest req contentType res accept) Params
rParamsL f SendinBlueRequest{..} = (\rParams -> SendinBlueRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (SendinBlueRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f SendinBlueRequest{..} = (\rAuthTypes -> SendinBlueRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => SendinBlueRequest req contentType res accept -> param -> SendinBlueRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: SendinBlueRequest req contentType res accept -> param -> SendinBlueRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: SendinBlueRequest req contentType res accept -> param -> SendinBlueRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** SendinBlueRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> SendinBlueRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = SendinBlueRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: SendinBlueRequest req contentType res accept -> [NH.Header] -> SendinBlueRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: SendinBlueRequest req contentType res accept -> [NH.HeaderName] -> SendinBlueRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => SendinBlueRequest req contentType res accept -> SendinBlueRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => SendinBlueRequest req contentType res accept -> SendinBlueRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: SendinBlueRequest req contentType res accept -> [NH.QueryItem] -> SendinBlueRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: SendinBlueRequest req contentType res accept -> WH.Form -> SendinBlueRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: SendinBlueRequest req contentType res accept -> NH.Part -> SendinBlueRequest req contentType res accept
...
_setBodyBS :: SendinBlueRequest req contentType res accept -> B.ByteString -> SendinBlueRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: SendinBlueRequest req contentType res accept -> BL.ByteString -> SendinBlueRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => SendinBlueRequest req contentType res accept -> P.Proxy authMethod -> SendinBlueRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: SendinBlueConfig
    -> a
    -> SendinBlueRequest req contentType res accept
    -> IO (SendinBlueRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> SendinBlueConfig
  -> IO (SendinBlueRequest req contentType res accept)
_applyAuthMethods req config@(SendinBlueConfig {configAuthMethods = as}) =
  foldlM go req as
  where
